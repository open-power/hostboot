...
{
    {
        ...
        uint64_t l_def_REFR_CHECK_INTERVAL = (l_def_REFRESH_INTERVAL * l_def_NUM_RANKS);
        ...
        fapi2::buffer<uint64_t> l_scom_buffer;
        {
            ...
            l_scom_buffer.insert<0, 8, 56, uint64_t>((l_TGT1_ATTR_MEM_EFF_DRAM_CL + literal_1) );
        ...
        }
        {
            ...
            l_scom_buffer.insert<20, 4, 60, uint64_t>(literal_0b1110 );
        ...
        }
        {
            ...
            l_scom_buffer.insert<54, 1, 63, uint64_t>(literal_0 );

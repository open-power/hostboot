...
constexpr uint64_t literal_61 = 61;
...
constexpr uint64_t literal_183 = 183;
...
{
    {
        ...
        fapi2::buffer<uint64_t> l_scom_buffer;
        {
            ...
            l_scom_buffer.insert<36, 6, 58, uint64_t>(literal_61 );
            l_scom_buffer.insert<62, 2, 62, uint64_t>(literal_2 );
            l_scom_buffer.insert<47, 5, 59, uint64_t>(literal_21 );
            l_scom_buffer.insert<42, 5, 59, uint64_t>(literal_21 );
            ...
            l_scom_buffer.insert<6, 6, 58, uint64_t>(literal_0 );
            l_scom_buffer.insert<12, 6, 58, uint64_t>(literal_0 );
            l_scom_buffer.insert<18, 6, 58, uint64_t>(literal_0 );
            FAPI_TRY(fapi2::putScom(TGT0, 0x801140cull, l_scom_buffer));
        }
        {
            FAPI_TRY(fapi2::getScom( TGT0, 0x801140dull, l_scom_buffer ));

            l_scom_buffer.insert<0, 4, 60, uint64_t>(literal_12 );
            l_scom_buffer.insert<4, 4, 60, uint64_t>(literal_8 );
            l_scom_buffer.insert<8, 4, 60, uint64_t>(literal_10 );
            l_scom_buffer.insert<12, 4, 60, uint64_t>(literal_8 );
            l_scom_buffer.insert<16, 4, 60, uint64_t>(literal_12 );
            l_scom_buffer.insert<20, 4, 60, uint64_t>(literal_8 );
            l_scom_buffer.insert<24, 4, 60, uint64_t>(literal_10 );
            l_scom_buffer.insert<28, 4, 60, uint64_t>(literal_8 );
            l_scom_buffer.insert<32, 5, 59, uint64_t>(literal_16 );
            l_scom_buffer.insert<37, 5, 59, uint64_t>(literal_16 );
            l_scom_buffer.insert<42, 5, 59, uint64_t>(literal_16 );
            l_scom_buffer.insert<47, 4, 60, uint64_t>(literal_15 );
            l_scom_buffer.insert<51, 6, 58, uint64_t>(literal_27 );
            l_scom_buffer.insert<57, 6, 58, uint64_t>(literal_27 );
        ...
        }
        {
            ...
            l_scom_buffer.insert<61, 3, 61, uint64_t>(literal_5 );
            l_scom_buffer.insert<58, 3, 61, uint64_t>(literal_5 );
        ...
        }
        {
            ...
            l_scom_buffer.insert<40, 8, 56, uint64_t>(literal_183 );
        ...
        }
        {
            ...
            l_scom_buffer.insert<17, 5, 59, uint64_t>(literal_27 );
            l_scom_buffer.insert<22, 5, 59, uint64_t>(literal_13 );
            l_scom_buffer.insert<12, 5, 59, uint64_t>(literal_20 );

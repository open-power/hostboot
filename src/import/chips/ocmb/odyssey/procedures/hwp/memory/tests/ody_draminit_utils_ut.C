        ...
        for_each_target([](const fapi2::Target<fapi2::TARGET_TYPE_OCMB_CHIP>& i_target)
        {
            for(const auto& l_port : mss::find_targets<fapi2::TARGET_TYPE_MEM_PORT>(i_target))
            {
                ...
                GIVEN("Test configure_dram_train_message_block");
                {
                    ...
                    uint8_t l_rtt_park_save[mss::ody::MAX_DIMM_PER_PORT][mss::ody::MAX_RANK_PER_DIMM] = {0};
                    ...
                    REQUIRE_RC_PASS(mss::attr::get_si_dram_rtt_park(l_port, l_rtt_park_save));
                    REQUIRE_RC_PASS(mss::attr::get_si_dram_rtt_park(l_port, l_rtt_park_test));
                    REQUIRE_RC_PASS(mss::attr::get_si_dram_rtt_wr(l_port, l_rtt_wr_save));
                    REQUIRE_RC_PASS(mss::attr::get_si_dram_rtt_wr(l_port, l_rtt_wr_test));
                    ...
                    l_rtt_park_test[0][0] = 40;
                    l_rtt_park_test[0][1] = 48;
                    REQUIRE_RC_PASS(mss::attr::set_si_dram_rtt_park(l_port, l_rtt_park_test));
                    ...
                    REQUIRE( l_msg_block.MR34_A1 == 0x1D );
                    REQUIRE( l_msg_block.MR34_A2 == 0x00 );
                    REQUIRE( l_msg_block.MR34_A3 == 0x00 );
                    REQUIRE( l_msg_block.MR34_B0 == 0x26 );
                    REQUIRE( l_msg_block.MR34_B1 == 0x1D );
                    ...
                    REQUIRE_RC_PASS(mss::attr::set_si_dram_rtt_park(l_port, l_rtt_park_save));
                    REQUIRE_RC_PASS(mss::attr::set_si_dram_rtt_wr(l_port, l_rtt_wr_save));

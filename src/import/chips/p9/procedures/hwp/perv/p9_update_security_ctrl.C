...
/*                                                                        */
/* $Source: src/import/chips/p9/procedures/hwp/perv/p9_update_security_ctrl.C $ */
/*                                                                        */
...
/* IBM_PROLOG_END_TAG                                                     */
//------------------------------------------------------------------------------
/// @file  p9_update_security_ctrl.C
///
        ...
        bool i_force_security)
{
    ...
    FAPI_INF("TPM Deconfig Attribute value : %#02x", l_set_tdp);


    //Get value of SAB bit to see if chip is in secure mode
    FAPI_TRY(fapi2::getScom(i_target_chip, PU_SECURITY_SWITCH_REGISTER_SCOM, l_data64));
    ...
    {
        FAPI_INF("Chip not in secure mode - No need to set SUL/TDP bits");
    }

    FAPI_INF("p9_update_security_ctrl : Exiting ...");

...
constexpr uint64_t literal_0b11000000001010000000000100000 = 0b11000000001010000000000100000;
...
{
    {
        ...
        }
        {
            ...
            l_scom_buffer.insert<0, 29, 35, uint64_t>(literal_0b11000000001010000000000100000 );

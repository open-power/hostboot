...
constexpr auto literal_0x000001000001FFFF = 0x000001000001FFFF;
constexpr auto literal_0xFF00FDFC0003FFFF = 0xFF00FDFC0003FFFF;
constexpr auto literal_0xFFFFFEFFFFFF8000 = 0xFFFFFEFFFFFF8000;
                              ...
                              const fapi2::Target<fapi2::TARGET_TYPE_SYSTEM>& TGT1)
{
    ...
    do
    {
        fapi2::buffer<uint64_t> l_scom_buffer;
        {
            ...
            {
                l_scom_buffer.insert<uint64_t> (literal_0x000001000001FFFF, 0, 54, 0 );
            }
        ...
        }
        {
            ...
            {
                l_scom_buffer.insert<uint64_t> (literal_0xFF00FDFC0003FFFF, 0, 54, 0 );
            }
        ...
        }
        {
            ...
            {
                l_scom_buffer.insert<uint64_t> (literal_0xFFFFFEFFFFFF8000, 0, 54, 0 );
            }

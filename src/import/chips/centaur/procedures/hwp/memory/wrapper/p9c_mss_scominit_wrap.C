...
/*                                                                        */
/* $Source: src/import/chips/centaur/procedures/hwp/memory/wrapper/p9c_mss_scominit_wrap.C $ */
/*                                                                        */
...
{
    // procedure constants
    std::string PROCEDURE = "p9c_mss_scominit_wrap";
...
{
    // procedure constants
    const std::string PROCEDURE = "p9c_mss_scominit_wrap";

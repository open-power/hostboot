...
/*                                                                        */
/* $Source: src/import/chips/centaur/procedures/hwp/memory/wrapper/p9c_mss_thermal_init_wrap.C $ */
/*                                                                        */
...
/*                                                                        */
/* IBM_PROLOG_END_TAG                                                     */
/// @file p9c_mss_thermal_init_wrap.C
/// @brief Wrapper to configure and start the OCC cache and Centaur thermal cache
///
...
{
    // procedure constants
    std::string PROCEDURE = "p9c_mss_thermal_init_wrap";
...
{
    // procedure constants
    const std::string PROCEDURE = "mss_thermal_init_wrap";

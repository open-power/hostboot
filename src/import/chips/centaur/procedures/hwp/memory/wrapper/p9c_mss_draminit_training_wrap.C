...
/*                                                                        */
/* $Source: src/import/chips/centaur/procedures/hwp/memory/wrapper/p9c_mss_draminit_training_wrap.C $ */
/*                                                                        */
...
/*                                                                        */
/* IBM_PROLOG_END_TAG                                                     */
/// @file p9c_mss_draminit_training_wrap.C
/// @brief HWP for training DRAMs in accordance w JEDEC Spec
///
...
{
    // procedure constants
    std::string PROCEDURE = "mss_draminit_training_wrap";
    std::string REVISION  = "$Revision: 1.3 $";
...
{
    // procedure constants
    const std::string PROCEDURE = "mss_draminit_training_wrap";
    const std::string REVISION  = "$Revision: 1.3 $";

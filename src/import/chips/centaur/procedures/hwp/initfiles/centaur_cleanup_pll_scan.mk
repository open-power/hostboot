...
#
# $Source: src/import/chips/centaur/procedures/hwp/initfiles/centaur_cleanup_pll_scan.mk $
#
...
#
# IBM_PROLOG_END_TAG
PROCEDURE=centaur_cleanup_pll_scan
lib$(PROCEDURE)_COMMONFLAGS+=-DFAPI_SUPPORT_SPY_AS_STRING=1
$(call BUILD_PROCEDURE)

PROCEDURE=centaur_cleanup_pll_scan_ifCompiler
lib$(PROCEDURE)_COMMONFLAGS+=-DFAPI_SUPPORT_SPY_AS_STRING=1
lib$(PROCEDURE)_COMMONFLAGS+=-DIFCOMPILER_PLAT=1
FAPI=2_IFCOMPILER
OBJS+=centaur_cleanup_pll_scan.o

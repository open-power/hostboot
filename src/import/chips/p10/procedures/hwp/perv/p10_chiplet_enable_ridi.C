...
/*                                                                        */
/* $Source: src/import/chips/p10/procedures/hwp/perv/p10_chiplet_enable_ridi.C $ */
/*                                                                        */
...
/* IBM_PROLOG_END_TAG                                                     */
//------------------------------------------------------------------------------
/// @file  p10_chiplet_enable_ridi.C
///
        ...
        fapi2::Target<fapi2::TARGET_TYPE_PROC_CHIP>& i_target_chip)
{
    ...
    FAPI_INF("p10_chiplet_enable_ridi: Entering ...");
    ...
    FAPI_DBG("p10_chiplet_enable_ridi: Exiting ...");

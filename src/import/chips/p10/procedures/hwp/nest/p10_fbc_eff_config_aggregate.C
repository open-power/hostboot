    ...
    uint8_t o_addr_dis[])
{
    /*
        ...
        uint8_t l_fbc_id_active_count[P10_FBC_UTILS_NUM_CHIP_IDS] = { 0 };
        ...
        // fabric ID
        for (uint8_t l_rem_fbc_id = 0; l_rem_fbc_id < P10_FBC_UTILS_NUM_CHIP_IDS; l_rem_fbc_id++)
        {
    ...
    const fapi2::Target<fapi2::TARGET_TYPE_PROC_CHIP>& i_target)
{
    ...
    /*
        ...
        // enable on local end
        uint8_t l_x_en[P10_FBC_UTILS_MAX_X_LINKS];
        uint8_t l_a_en[P10_FBC_UTILS_MAX_A_LINKS];
        // link/fabric ID on other end
        uint8_t l_x_rem_link_id[P10_FBC_UTILS_MAX_X_LINKS];
        uint8_t l_x_rem_fbc_chip_id[P10_FBC_UTILS_MAX_X_LINKS];
        uint8_t l_a_rem_link_id[P10_FBC_UTILS_MAX_A_LINKS];
        uint8_t l_a_rem_fbc_group_id[P10_FBC_UTILS_MAX_A_LINKS];
        ...
        uint8_t l_x_addr_dis[P10_FBC_UTILS_MAX_X_LINKS];
        uint8_t l_x_aggregate;
        uint8_t l_a_addr_dis[P10_FBC_UTILS_MAX_A_LINKS];

...
const uint8_t P10_BUILD_SMP_NUM_SHADOWS = 3;

// HP (HotPlug Mode Register)
const uint64_t PB_HP_MODE_CURR_SHADOWS[P10_BUILD_SMP_NUM_SHADOWS] =
{
...
const uint64_t PB_HP_MODE_NEXT_SHADOWS[P10_BUILD_SMP_NUM_SHADOWS] =
{
...
const uint64_t PB_HPX_MODE_CURR_SHADOWS[P10_BUILD_SMP_NUM_SHADOWS] =
{
...
const uint64_t PB_HPX_MODE_NEXT_SHADOWS[P10_BUILD_SMP_NUM_SHADOWS] =
{
...
// HPA
const uint64_t PB_HPA_MODE_CURR_SHADOWS[P10_BUILD_SMP_NUM_SHADOWS] =
{
...
const uint64_t PB_HPA_MODE_NEXT_SHADOWS[P10_BUILD_SMP_NUM_SHADOWS] =
{
...
///
fapi2::ReturnCode p10_build_smp_get_hp_ab_shadow(
    ...
    fapi2::buffer<uint64_t>& o_data)
{
    ...
    for (uint8_t rr = 0; rr < P10_BUILD_SMP_NUM_SHADOWS; rr++)
    {
        ...
        FAPI_ASSERT((rr == 0) || (l_scom_data == o_data),
                    fapi2::P10_BUILD_SMP_HOTPLUG_SHADOW_ERR()
                    .set_TARGET(i_target)
...
/// @return fapi2:ReturnCode. FAPI2_RC_SUCCESS if success, else error code.
///
fapi2::ReturnCode p10_build_smp_set_hp_ab_shadow(
    const fapi2::Target<fapi2::TARGET_TYPE_PROC_CHIP> i_target,
    const uint64_t i_shadow_regs[],
...
///
fapi2::ReturnCode
p10_build_smp_copy_hp_ab_next_curr(
    const fapi2::Target<fapi2::TARGET_TYPE_PROC_CHIP> i_target)
{
    FAPI_DBG("Start");
    ...
    // read NEXT
    FAPI_TRY(p10_build_smp_get_hp_ab_shadow(i_target, PB_HP_MODE_NEXT_SHADOWS, l_hp_mode_data),
             "Error from p10_build_smp_get_hp_ab_shadow (HP_MODE)");
    FAPI_TRY(p10_build_smp_get_hp_ab_shadow(i_target, PB_HPX_MODE_NEXT_SHADOWS, l_hpx_mode_data),
             "Error from p10_build_smp_get_hp_ab_shadow (HPX_MODE)");
    FAPI_TRY(p10_build_smp_get_hp_ab_shadow(i_target, PB_HPA_MODE_NEXT_SHADOWS, l_hpa_mode_data),
             "Error from p10_build_smp_get_hp_ab_shadow (HPA_MODE)");

    // write CURR
    FAPI_TRY(p10_build_smp_set_hp_ab_shadow(i_target, PB_HP_MODE_CURR_SHADOWS, l_hp_mode_data),
             "Error from p10_build_smp_set_hp_ab_shadow (HP_MODE)");
    FAPI_TRY(p10_build_smp_set_hp_ab_shadow(i_target, PB_HPX_MODE_CURR_SHADOWS, l_hpx_mode_data),
             "Error from p10_build_smp_set_hp_ab_shadow (HPX_MODE)");
    FAPI_TRY(p10_build_smp_set_hp_ab_shadow(i_target, PB_HPA_MODE_CURR_SHADOWS, l_hpa_mode_data),
             "Error from p10_build_smp_set_hp_ab_shadow (HPA_MODE)");
...
///
fapi2::ReturnCode
p10_build_smp_copy_hp_ab_curr_next(
    const fapi2::Target<fapi2::TARGET_TYPE_PROC_CHIP> i_target)
{
    FAPI_DBG("Start");
    fapi2::buffer<uint64_t> l_hp_mode_data;
    ...
    // read CURR
    FAPI_TRY(p10_build_smp_get_hp_ab_shadow(i_target, PB_HP_MODE_CURR_SHADOWS, l_hp_mode_data),
             "Error from p10_build_smp_get_hp_ab_shadow (HP_MODE)");
    FAPI_TRY(p10_build_smp_get_hp_ab_shadow(i_target, PB_HPX_MODE_CURR_SHADOWS, l_hpx_mode_data),
             "Error from p10_build_smp_get_hp_ab_shadow (HPX_MODE)");
    FAPI_TRY(p10_build_smp_get_hp_ab_shadow(i_target, PB_HPA_MODE_CURR_SHADOWS, l_hpa_mode_data),
             "Error from p10_build_smp_get_hp_ab_shadow (HPA_MODE)");

    // write NEXT
    FAPI_TRY(p10_build_smp_set_hp_ab_shadow(i_target, PB_HP_MODE_NEXT_SHADOWS, l_hp_mode_data),
             "Error from p10_build_smp_set_hp_ab_shadow (HP_MODE)");
    FAPI_TRY(p10_build_smp_set_hp_ab_shadow(i_target, PB_HPX_MODE_NEXT_SHADOWS, l_hpx_mode_data),
             "Error from p10_build_smp_set_hp_ab_shadow (HPX_MODE)");
    FAPI_TRY(p10_build_smp_set_hp_ab_shadow(i_target, PB_HPA_MODE_NEXT_SHADOWS, l_hpa_mode_data),
             "Error from p10_build_smp_set_hp_ab_shadow (HPA_MODE)");
...
fapi2::ReturnCode p10_build_smp_set_fbc_ab(p10_build_smp_system& i_smp,

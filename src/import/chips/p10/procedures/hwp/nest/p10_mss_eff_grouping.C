...
// RTC 208756: Replace with p10 versions when avail
#if 0
...
// P10 allows 1, 2, 3, 4, 6, or 8 memory ports to be grouped together.
enum GroupAllowed
{
...
// TODO: To be removed in P10    fapi2::ATTR_CHIP_EC_FEATURE_HW423589_OPTION2_Type iv_hw423589_option2;
};
...
#if 0 // TODO: To be removed in P10    if (iv_hw423589_option2)
    {
...
// TODO: To be replaced with new enum for ATTR_MRW_HW_MIRRORING_ENABLE in p10_nest_attributes.xml
#if 0
    ...
    if (iv_hwMirrorEnabled == fapi2::ENUM_ATTR_MRW_HW_MIRRORING_ENABLE_REQUIRED && !i_is_axone)
    {
...
// TODO: To be removed in P10     fapi2::ATTR_CHIP_EC_FEATURE_EXTENDED_ADDRESSING_MODE_Type l_extended_addressing_mode = 0;
...
#if 0 // TODO: To be removed in P10
...
#if 0 // TODO: To be removed in P10, it doesn't have extended addressing mode.
    ...
    if (l_extended_addressing_mode)
    {
        ...
        if (iv_smfConfig && iv_smfSupported)
        {
            ...
            iv_smfEnabled = fapi2::ENUM_ATTR_SMF_ENABLED_REQUIRED;
        }
...
# if 0
    Note:
        In P10
        ATTR_PROC_FABRIC_SYSTEM_ID is not used
        ATTR_PROC_FABRIC_GROUP_ID and ATTR_PROC_FABRIC_CHIP_ID will be replaced with ATTR_PROC_FABRIC_TOPOLOGY_ID
...
#if 0 // TODO: To be revisited in part 2
...
#if 0
// See above note for the use of these attributes in P10
...
#if 0
// See above note about these values
...
// TODO: To be removed in P10      fapi2::ATTR_CHIP_EC_FEATURE_OMI_Type l_omi;
...
/// template specialization for DMI target type
        ...
        fapi2::ReturnCode & o_rc)
    {
        ...
        // loss of DIMMs
        if (i_hwMirrorEnabled == fapi2::ENUM_ATTR_MRW_HW_MIRRORING_ENABLE_REQUIRED)
        {
...
///
        ...
        EffGroupingData & io_groupData)
    {
        ...
        if ( (l_miChiplets.size() == 0) ||
             (i_sysAttrs.iv_hwMirrorEnabled == fapi2::ENUM_ATTR_MRW_HW_MIRRORING_ENABLE_OFF) )
        {
...
///
        ...
        const fapi2::Target<fapi2::TARGET_TYPE_PROC_CHIP>& i_target)
    {
        ...
        // P10 MC architecture allows 1, 2, 3, 4, 6, or 8 MC ports to be grouped
        // together.
        ...
        l_mirrorReq = (l_sysAttrs.iv_hwMirrorEnabled == fapi2::ENUM_ATTR_MRW_HW_MIRRORING_ENABLE_REQUIRED);

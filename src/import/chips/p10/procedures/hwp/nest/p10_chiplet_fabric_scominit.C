...
fapi2::ReturnCode p10_fbc_no_hp_scom(const fapi2::Target<fapi2::TARGET_TYPE_PROC_CHIP>& i_target)
{
    ...
    FAPI_TRY(GET_PB_COM_SCOM_ES3_STATION_SNOOPER_CFG1(i_target, l_data));
    SET_PB_COM_SCOM_ES3_STATION_SNOOPER_CFG1_PB_CFG_CHG_RATE_GP_CRESP_SAMPLE_TIME(0x141, l_data);
    SET_PB_COM_SCOM_ES3_STATION_SNOOPER_CFG1_PB_CFG_CHG_RATE_GP_JUMP(0b010, l_data);
    SET_PB_COM_SCOM_ES3_STATION_SNOOPER_CFG1_PB_CFG_CHG_RATE_GP_REQ_SAMPLE_TIME(0x400, l_data);
    SET_PB_COM_SCOM_ES3_STATION_SNOOPER_CFG1_PB_CFG_CHG_RATE_SP_CRESP_SAMPLE_TIME(0x30D, l_data);
    SET_PB_COM_SCOM_ES3_STATION_SNOOPER_CFG1_PB_CFG_CHG_RATE_SP_JUMP(0b010, l_data);
    SET_PB_COM_SCOM_ES3_STATION_SNOOPER_CFG1_PB_CFG_CHG_RATE_SP_REQ_SAMPLE_TIME(0x400, l_data);
    FAPI_TRY(PUT_PB_COM_SCOM_ES3_STATION_SNOOPER_CFG1(i_target, l_data));

    FAPI_DBG("Configuring pb_snooper_cfg2 register...");
    FAPI_TRY(GET_PB_COM_SCOM_ES3_STATION_SNOOPER_CFG2(i_target, l_data));
    SET_PB_COM_SCOM_ES3_STATION_SNOOPER_CFG2_PB_CFG_CHG_RATE_GP_RTY_THRESHOLD(0x5, l_data);
    SET_PB_COM_SCOM_ES3_STATION_SNOOPER_CFG2_PB_CFG_CHG_RATE_SP_RTY_THRESHOLD(0x4, l_data);
    SET_PB_COM_SCOM_ES3_STATION_SNOOPER_CFG2_PB_CFG_CPO_JUMP_LEVEL(0b111, l_data);
    SET_PB_COM_SCOM_ES3_STATION_SNOOPER_CFG2_PB_CFG_CPO_RTY_LEVEL(0x2, l_data);
    FAPI_TRY(PUT_PB_COM_SCOM_ES3_STATION_SNOOPER_CFG2(i_target, l_data));

    FAPI_DBG("Configuring pb_snooper_cfg3 register...");
    FAPI_TRY(GET_PB_COM_SCOM_ES3_STATION_SNOOPER_CFG3(i_target, l_data));
    SET_PB_COM_SCOM_ES3_STATION_SNOOPER_CFG3_PB_CFG_GP_LVL0_CHGRATE_CLK_DIV(0b000, l_data);
    SET_PB_COM_SCOM_ES3_STATION_SNOOPER_CFG3_PB_CFG_GP_LVL1_CHGRATE_CLK_DIV(0b000, l_data);
    SET_PB_COM_SCOM_ES3_STATION_SNOOPER_CFG3_PB_CFG_GP_LVL2_CHGRATE_CLK_DIV(0b000, l_data);
    SET_PB_COM_SCOM_ES3_STATION_SNOOPER_CFG3_PB_CFG_GP_LVL3_CHGRATE_CLK_DIV(0b001, l_data);
    SET_PB_COM_SCOM_ES3_STATION_SNOOPER_CFG3_PB_CFG_GP_LVL4_CHGRATE_CLK_DIV(0b001, l_data);
    SET_PB_COM_SCOM_ES3_STATION_SNOOPER_CFG3_PB_CFG_GP_LVL5_CHGRATE_CLK_DIV(0b010, l_data);
    SET_PB_COM_SCOM_ES3_STATION_SNOOPER_CFG3_PB_CFG_GP_LVL6_CHGRATE_CLK_DIV(0b011, l_data);
    SET_PB_COM_SCOM_ES3_STATION_SNOOPER_CFG3_PB_CFG_GP_LVL7_CHGRATE_CLK_DIV(0b101, l_data);
    SET_PB_COM_SCOM_ES3_STATION_SNOOPER_CFG3_PB_CFG_SP_LVL0_CHGRATE_CLK_DIV(0b000, l_data);
    SET_PB_COM_SCOM_ES3_STATION_SNOOPER_CFG3_PB_CFG_SP_LVL1_CHGRATE_CLK_DIV(0b000, l_data);
    SET_PB_COM_SCOM_ES3_STATION_SNOOPER_CFG3_PB_CFG_SP_LVL2_CHGRATE_CLK_DIV(0b000, l_data);
    SET_PB_COM_SCOM_ES3_STATION_SNOOPER_CFG3_PB_CFG_SP_LVL3_CHGRATE_CLK_DIV(0b001, l_data);
    SET_PB_COM_SCOM_ES3_STATION_SNOOPER_CFG3_PB_CFG_SP_LVL4_CHGRATE_CLK_DIV(0b001, l_data);
    SET_PB_COM_SCOM_ES3_STATION_SNOOPER_CFG3_PB_CFG_SP_LVL5_CHGRATE_CLK_DIV(0b010, l_data);
    SET_PB_COM_SCOM_ES3_STATION_SNOOPER_CFG3_PB_CFG_SP_LVL6_CHGRATE_CLK_DIV(0b011, l_data);
    SET_PB_COM_SCOM_ES3_STATION_SNOOPER_CFG3_PB_CFG_SP_LVL7_CHGRATE_CLK_DIV(0b101, l_data);
    FAPI_TRY(PUT_PB_COM_SCOM_ES3_STATION_SNOOPER_CFG3(i_target, l_data));

    FAPI_DBG("Configuring pb_snooper_cfg4 register...");
    FAPI_TRY(GET_PB_COM_SCOM_ES3_STATION_SNOOPER_CFG4(i_target, l_data));
    SET_PB_COM_SCOM_ES3_STATION_SNOOPER_CFG4_PB_CFG_HANG0_CMD_RATE(0b00000, l_data);
    SET_PB_COM_SCOM_ES3_STATION_SNOOPER_CFG4_PB_CFG_HANG1_CMD_RATE(0b00110, l_data);
    SET_PB_COM_SCOM_ES3_STATION_SNOOPER_CFG4_PB_CFG_HANG2_CMD_RATE(0b01101, l_data);
    SET_PB_COM_SCOM_ES3_STATION_SNOOPER_CFG4_PB_CFG_HANG3_CMD_RATE(0b00000, l_data);
    SET_PB_COM_SCOM_ES3_STATION_SNOOPER_CFG4_PB_CFG_HANG4_CMD_RATE(0b11110, l_data);
    SET_PB_COM_SCOM_ES3_STATION_SNOOPER_CFG4_PB_CFG_HANG5_CMD_RATE(0b11001, l_data);
    SET_PB_COM_SCOM_ES3_STATION_SNOOPER_CFG4_PB_CFG_HANG6_CMD_RATE(0b00000, l_data);
    SET_PB_COM_SCOM_ES3_STATION_SNOOPER_CFG4_PB_CFG_USE_SLOW_GO_RATE_ES3(0x0000, l_data);
    FAPI_TRY(PUT_PB_COM_SCOM_ES3_STATION_SNOOPER_CFG4(i_target, l_data));

...
p10_io_ppe_sram_reg p10_io_ppe_ppe_debug_log_num(&p10_io_ppe_img_regs, 0b000000100, 0x1fc, 2);
...
p10_io_ppe_sram_reg p10_io_ppe_ppe_watchdog_select_sim_mode(&p10_io_ppe_img_regs, 0b000000000, 0x1e00, 9);

...
/*                                                                        */
/* $Source: src/import/chips/p10/procedures/hwp/pm/p10_pm_get_poundv_bucket.C $ */
/*                                                                        */
...
/* IBM_PROLOG_END_TAG                                                     */
///
/// @file p10_pm_get_poundv_bucket.C
...
{
    FAPI_DBG("Entering p10_pm_get_poundv_bucket ....");

    //clear the output variable
    memset (&o_data, 0, sizeof(fapi2::voltageBucketData_t));

    //Set up a char array to hold the bucket data from an attr read
    fapi2::ATTR_POUNDV_BUCKET_DATA_Type l_bucketAttr;

    //Perform an ATTR_GET for POUNDV_BUCKET data on the proc target

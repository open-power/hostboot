    ...
    for (c = 0 ; c < MAXIMUM_CORES; c++)
    {
        for (p = 0; p < NUM_PV_POINTS; p++)
        {
            fprintf(stream, "\t%4u %13s %7lu %6lu %7lu %5lu %5lu %5lu %5lu %5lu %11lu %9lu %11lu %9lu %9lu %9lu\n",
                    c,
                    vpdPvStr[p],
                    gppb->dds[c][vpdPv[p]].ddsc.fields.calb_adj,
                    gppb->dds[c][vpdPv[p]].ddsc.fields.insrtn_dely,
                    gppb->dds[c][vpdPv[p]].ddsc.fields.trip_offset,
                    gppb->dds[c][vpdPv[p]].ddsc.fields.data0_select,
                    gppb->dds[c][vpdPv[p]].ddsc.fields.data1_select,
                    gppb->dds[c][vpdPv[p]].ddsc.fields.data2_select,
                    gppb->dds[c][vpdPv[p]].ddsc.fields.large_droop,
                    gppb->dds[c][vpdPv[p]].ddsc.fields.small_droop,
                    gppb->dds[c][vpdPv[p]].ddsc.fields.slopeA_start,
                    gppb->dds[c][vpdPv[p]].ddsc.fields.slopeA_end,
                    gppb->dds[c][vpdPv[p]].ddsc.fields.slopeB_start,
                    gppb->dds[c][vpdPv[p]].ddsc.fields.slopeB_end,
                    gppb->dds[c][vpdPv[p]].ddsc.fields.slopeA_cycles,
                    gppb->dds[c][vpdPv[p]].ddsc.fields.slopeB_cycles
                   );
        }
    }

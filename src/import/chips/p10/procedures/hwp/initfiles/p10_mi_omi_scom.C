...
{
    {
        fapi2::ATTR_MEM_MIRROR_PLACEMENT_POLICY_Type l_TGT3_ATTR_MEM_MIRROR_PLACEMENT_POLICY;
        FAPI_TRY(FAPI_ATTR_GET(fapi2::ATTR_MEM_MIRROR_PLACEMENT_POLICY, TGT3, l_TGT3_ATTR_MEM_MIRROR_PLACEMENT_POLICY));
        ...
        fapi2::buffer<uint64_t> l_scom_buffer;
        {
            ...
            constexpr auto l_MCP_PBI01_SCOMFIR_MCPERF1_EN_SPEC_EDATA_ON = 0x1;
            l_scom_buffer.insert<44, 1, 63, uint64_t>(l_MCP_PBI01_SCOMFIR_MCPERF1_EN_SPEC_EDATA_ON );
        ...
        }
        {
            ...
            if ((l_TGT3_ATTR_MEM_MIRROR_PLACEMENT_POLICY == fapi2::ENUM_ATTR_MEM_MIRROR_PLACEMENT_POLICY_FLIPPED))
            {
            ...
            else if ((l_TGT3_ATTR_MEM_MIRROR_PLACEMENT_POLICY == fapi2::ENUM_ATTR_MEM_MIRROR_PLACEMENT_POLICY_NORMAL))
            {
        ...
        }
        {
            ...
            {
                constexpr auto l_MCP_PBI01_SCOMFIR_MCTO_SELECT_PB_HANG_PULSE_ON = 0x1;
                l_scom_buffer.insert<0, 1, 63, uint64_t>(l_MCP_PBI01_SCOMFIR_MCTO_SELECT_PB_HANG_PULSE_ON );
            }

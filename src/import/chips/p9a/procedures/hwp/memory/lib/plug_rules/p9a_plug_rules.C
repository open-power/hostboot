...
spd_lookup_key::spd_lookup_key(const fapi2::Target<fapi2::TARGET_TYPE_DIMM>& i_target, fapi2::ReturnCode& o_rc)
{
    ...
    {
        constexpr uint64_t START = mss::axone::SERIAL_PART_NUMBER;
        constexpr uint64_t END = START + mss::axone::SERIAL_PART_NUMBER_LEN;
    ...
    {
        constexpr uint64_t START = mss::axone::SERIAL_RAW_CARD;
        constexpr uint64_t END = START + mss::axone::SERIAL_RAW_CARD_LEN;

...
constexpr mss::field_t<mss::endian::LITTLE> fields<DDR5, DDIMM_MODULE>::SPD_DEVICE_TYPE;
...
constexpr mss::field_t<mss::endian::LITTLE> fields<DDR5, DDIMM_MODULE>::PMIC0_DEVICE_TYPE;
...
constexpr mss::field_t<mss::endian::LITTLE> fields<DDR5, DDIMM_MODULE>::PMIC1_DEVICE_TYPE;
...
constexpr mss::field_t<mss::endian::LITTLE> fields<DDR5, DDIMM_MODULE>::PMIC2_DEVICE_TYPE;
...
constexpr mss::field_t<mss::endian::LITTLE> fields<DDR5, DDIMM_MODULE>::THERMAL_SENSOR0_DEVICE_TYPE;
...
constexpr mss::field_t<mss::endian::LITTLE> fields<DDR5, DDIMM_MODULE>::PMIC3_DEVICE_TYPE;
...
constexpr mss::field_t<mss::endian::LITTLE> fields<DDR5, DDIMM_MODULE>::THERMAL_SENSOR1_DEVICE_TYPE;
...
constexpr mss::field_t<mss::endian::LITTLE> fields<DDR5, DDIMM_MODULE>::THERMAL_SENSOR2_DEVICE_TYPE;
...
constexpr mss::field_t<mss::endian::LITTLE> fields<DDR5, DDIMM_MODULE>::THERMAL_SENSOR3_DEVICE_TYPE;

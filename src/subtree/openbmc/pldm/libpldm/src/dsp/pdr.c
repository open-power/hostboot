...
/** Hostboot patch:
* get_new_record_handle() was added and must used in place of
* get_next_record_handle() by pldm_pdr_add() for the pldm to
* retrieve pdr records outside of the bmc range. If not included
* a critical failure will occur on hardware.
*/

    ...
    while (i+4) <= len(data):
        ...
        if attrEnum == 0x00116c3:
            ...
            for x in range(1):
                traceEntry.append(hexConcat(data, i, i+1)[0])
                i += 1
        elif attrEnum == 0x0157499:
            #simpleType:uint
            label = "MSS_OMI_VDD_UPLIFT_APPLIED"
            for x in range(1):
                traceEntry.append(hexConcat(data, i, i+1)[0])
                i += 1
            ...
            for x in range(1):
                traceEntry.append(hexConcat(data, i, i+8)[0])
                i += 8
        elif attrEnum == 0x0663f9d:
            #simpleType:uint
            label = "SKIP_PLUG_RULES_IN_EFF_CONFIG_THERMAL"
            for x in range(1):
                traceEntry.append(hexConcat(data, i, i+1)[0])
                i += 1
        elif attrEnum == 0x06668e3:
            #simpleType:uint
            label = "WTH_OVERRIDE_EFFICIENCY_CEFF_ADJUST"
            traceEntry.append("[8][4]:")
            for x in range(32):
                traceEntry.append(hexConcat(data, i, i+1)[0])
                i += 1
            ...
            for x in range(1):
                traceEntry.append(hexConcat(data, i, i+1)[0])
                i += 1
        elif attrEnum == 0x0b391d7:
            #simpleType:uint
            label = "SYSTEM_MAX_OPERATING_FREQ_MHZ"
            for x in range(1):
                traceEntry.append(hexConcat(data, i, i+4)[0])
                i += 4
            ...
            for x in range(1):
                traceEntry.append(hexConcat(data, i, i+1)[0])
                i += 1
        elif attrEnum == 0x0dcd6cd:
            #simpleType:uint
            label = "WTH_OVERRIDE_EFFICIENCY_IDLE_THRESH"
            traceEntry.append("[8][2]:")
            for x in range(16):
                traceEntry.append(hexConcat(data, i, i+2)[0])
                i += 2
            ...
            for x in range(1):
                traceEntry.append(hexConcat(data, i, i+8)[0])
                i += 8
        elif attrEnum == 0x13fdcc3:
            #simpleType:uint
            label = "INTERPOSER_REV"
            for x in range(1):
                traceEntry.append(hexConcat(data, i, i+1)[0])
                i += 1
            ...
            for x in range(2):
                traceEntry.append(hexConcat(data, i, i+4)[0])
                i += 4
        elif attrEnum == 0x1e53923:
            #simpleType:uint
            label = "MEM_EFF_DDR5_MIN_SUPPORTED_SPD_REVISION"
            for x in range(1):
                traceEntry.append(hexConcat(data, i, i+1)[0])
                i += 1
            ...
            for x in range(1):
                traceEntry.append(hexConcat(data, i, i+1)[0])
                i += 1
        elif attrEnum == 0x216a1a7:
            #simpleType:uint
            label = "ODY_SWIZZLE_DETECT_FAIL_VALUE"
            for x in range(1):
                traceEntry.append(hexConcat(data, i, i+2)[0])
                i += 2
            ...
            for x in range(1):
                traceEntry.append(hexConcat(data, i, i+1)[0])
                i += 1
        elif attrEnum == 0x24a8d09:
            #simpleType:uint
            label = "SKIP_HBRT_ATTR_UPDATE"
            for x in range(1):
                traceEntry.append(hexConcat(data, i, i+1)[0])
                i += 1
            ...
            for x in range(1):
                traceEntry.append(hexConcat(data, i, i+4)[0])
                i += 4
        elif attrEnum == 0x2763107:
            #simpleType:uint
            label = "PMIC_CALLBACK_STAGGER_TIME"
            for x in range(1):
                traceEntry.append(hexConcat(data, i, i+4)[0])
                i += 4
            ...
            pass #not readable
        elif attrEnum == 0x290257b:
            #simpleType:uint
            label = "WOV_OVERV_EXTENDED_MAX_10THPCT"
            for x in range(1):
                traceEntry.append(hexConcat(data, i, i+2)[0])
                i += 2
            ...
            for x in range(1):
                traceEntry.append(hexConcat(data, i, i+1)[0])
                i += 1
        elif attrEnum == 0x2a435a0:
            #simpleType:uint
            label = "SBE_DUMP_EFFECTER_ID"
            for x in range(1):
                traceEntry.append(hexConcat(data, i, i+2)[0])
                i += 2
            ...
            for x in range(1):
                traceEntry.append(hexConcat(data, i, i+2)[0])
                i += 2
        elif attrEnum == 0x3c0bdfa:
            #simpleType:uint
            label = "WTH_OVERRIDE_EFFICIENCY_IDLE_TIMES"
            traceEntry.append("[8][2]:")
            for x in range(16):
                traceEntry.append(hexConcat(data, i, i+2)[0])
                i += 2
            ...
            for x in range(2):
                traceEntry.append(hexConcat(data, i, i+1)[0])
                i += 1
        elif attrEnum == 0x3d57633:
            #simpleType:uint
            label = "WOF_TABLE_IO_POWER_BASE_W"
            for x in range(1):
                traceEntry.append(hexConcat(data, i, i+1)[0])
                i += 1
            ...
            for x in range(1):
                traceEntry.append(hexConcat(data, i, i+1)[0])
                i += 1
        elif attrEnum == 0x3f8999b:
            #simpleType:uint
            label = "MSS_MRW_IDLE_PSMODE_MIN_DOMAIN_REDUCTION_TIME"
            for x in range(1):
                traceEntry.append(hexConcat(data, i, i+2)[0])
                i += 2
            ...
            for x in range(1):
                traceEntry.append(hexConcat(data, i, i+1)[0])
                i += 1
        elif attrEnum == 0x434f057:
            #simpleType:uint
            label = "ODY_DRAMINIT_ERROR_ON_FAILURE"
            for x in range(1):
                traceEntry.append(hexConcat(data, i, i+1)[0])
                i += 1
            ...
            for x in range(1):
                traceEntry.append(hexConcat(data, i, i+1)[0])
                i += 1
        elif attrEnum == 0x53689d6:
            #simpleType:uint
            label = "IO_IOHS_CHANNEL_LOSS_ISC1_WORKAROUND"
            for x in range(1):
                traceEntry.append(hexConcat(data, i, i+1)[0])
                i += 1
            ...
            for x in range(1):
                traceEntry.append(hexConcat(data, i, i+1)[0])
                i += 1
        elif attrEnum == 0x5edbee6:
            #simpleType:uint
            label = "PCIE_FW_LEGACY_MODE"
            for x in range(1):
                traceEntry.append(hexConcat(data, i, i+1)[0])
                i += 1
            ...
            for x in range(1):
                traceEntry.append(hexConcat(data, i, i+2)[0])
                i += 2
        elif attrEnum == 0x609c749:
            #simpleType:uint
            label = "WTH_OVERRIDE_EFFICIENCY_FREQ_LIMITS"
            traceEntry.append("[8][4]:")
            for x in range(32):
                traceEntry.append(hexConcat(data, i, i+2)[0])
                i += 2
            ...
            for x in range(15):
                traceEntry.append(hexConcat(data, i, i+1)[0])
                i += 1
        elif attrEnum == 0x6b72984:
            #simpleType:uint
            label = "DISABLE_PREDICTIVE_MEM_GUARD"
            for x in range(1):
                traceEntry.append(hexConcat(data, i, i+1)[0])
                i += 1
            ...
            for x in range(1):
                traceEntry.append(hexConcat(data, i, i+1)[0])
                i += 1
        elif attrEnum == 0x6bae177:
            #simpleType:uint
            label = "DEBUG_ODY_HRESET_CONTROL"
            for x in range(1):
                traceEntry.append(hexConcat(data, i, i+1)[0])
                i += 1
            ...
            pass
        elif attrEnum == 0x703fb93:
            #simpleType:uint
            label = "MEM_DDR5_PLUG_RULES_SPD_REV_TESTED"
            for x in range(1):
                traceEntry.append(hexConcat(data, i, i+1)[0])
                i += 1
            ...
            for x in range(1):
                traceEntry.append(hexConcat(data, i, i+4)[0])
                i += 4
        elif attrEnum == 0x75e33d3:
            #simpleType:uint
            label = "PCIE_FW_LEGACY_MODE_IN_HWIMG"
            for x in range(1):
                traceEntry.append(hexConcat(data, i, i+1)[0])
                i += 1
            ...
            for x in range(1):
                traceEntry.append(hexConcat(data, i, i+4)[0])
                i += 4
        elif attrEnum == 0x7d6c44c:
            #simpleType:uint
            label = "MSS_MRW_CONFIG_FREQ_LIMIT"
            traceEntry.append("[8]:")
            for x in range(8):
                traceEntry.append(hexConcat(data, i, i+2)[0])
                i += 2
            ...
            for x in range(1):
                traceEntry.append(hexConcat(data, i, i+1)[0])
                i += 1
        elif attrEnum == 0x7dfffde:
            #simpleType:uint
            label = "MSS_MRW_MIN_DOMAIN_REDUCTION_TIME_FOR_POWER_CONTROL_OFF"
            for x in range(1):
                traceEntry.append(hexConcat(data, i, i+2)[0])
                i += 2
            ...
            for x in range(1):
                traceEntry.append(hexConcat(data, i, i+4)[0])
                i += 4
        elif attrEnum == 0x83950cf:
            #simpleType:uint
            label = "ECS_ERROR_COUNT_THRESHOLD"
            for x in range(1):
                traceEntry.append(hexConcat(data, i, i+1)[0])
                i += 1
            ...
            if attr == 0x00000050:
                 ...
                 traceEntry.append("PROC_MODULE_TYPE_P11_GODEL")
            elif attr == 0x00000053:
                 traceEntry.append("PROC_MODULE_TYPE_P11_BLAISE")
            ...
            for x in range(1):
                traceEntry.append(hexConcat(data, i, i+1)[0])
                i += 1
        elif attrEnum == 0x85528b9:
            #simpleType:uint
            label = "IO_IOHS_PRE1_ISC1_WORKAROUND"
            for x in range(1):
                traceEntry.append(hexConcat(data, i, i+1)[0])
                i += 1
            ...
            for x in range(192):
                traceEntry.append(hexConcat(data, i, i+1)[0])
                i += 1
        elif attrEnum == 0x8a18c2a:
            #simpleType:uint
            label = "MRW_MAX_DDR_FREQ_PER_SLOT"
            for x in range(1):
                traceEntry.append(hexConcat(data, i, i+2)[0])
                i += 2
            ...
            for x in range(2):
                traceEntry.append(hexConcat(data, i, i+1)[0])
                i += 1
        elif attrEnum == 0x8b4f3ef:
            #simpleType:uint
            label = "MEM_IGNORE_PLUG_RULES_SPD_REV_CHECK"
            for x in range(1):
                traceEntry.append(hexConcat(data, i, i+1)[0])
                i += 1
            ...
            for x in range(1):
                traceEntry.append(hexConcat(data, i, i+1)[0])
                i += 1
        elif attrEnum == 0x8f2556b:
            #simpleType:uint
            label = "MSS_CONFIG_FREQ_LIMIT"
            for x in range(1):
                traceEntry.append(hexConcat(data, i, i+4)[0])
                i += 4
            ...
            for x in range(8):
                traceEntry.append(hexConcat(data, i, i+2)[0])
                i += 2
        elif attrEnum == 0x968f7cc:
            #simpleType:uint
            label = "FREQ_PAU_VPD_MHZ"
            for x in range(1):
                traceEntry.append(hexConcat(data, i, i+4)[0])
                i += 4
            ...
            for x in range(1):
                traceEntry.append(hexConcat(data, i, i+1)[0])
                i += 1
        elif attrEnum == 0x997b4ac:
            #simpleType:uint
            label = "I2C_FAIL_COUNT"
            for x in range(1):
                traceEntry.append(hexConcat(data, i, i+1)[0])
                i += 1
            ...
            for x in range(1):
                traceEntry.append(hexConcat(data, i, i+4)[0])
                i += 4
        elif attrEnum == 0x9a2f3fb:
            #simpleType:uint
            label = "INCREASED_PAU_FREQ"
            for x in range(1):
                traceEntry.append(hexConcat(data, i, i+1)[0])
                i += 1
            ...
            for x in range(2):
                traceEntry.append(hexConcat(data, i, i+2)[0])
                i += 2
        elif attrEnum == 0x9c25304:
            #simpleType:uint
            label = "SBE_DUMP_SENSOR_ID"
            for x in range(1):
                traceEntry.append(hexConcat(data, i, i+2)[0])
                i += 2
            ...
            for x in range(1):
                traceEntry.append(hexConcat(data, i, i+4)[0])
                i += 4
        elif attrEnum == 0x9e6ab5c:
            #simpleType:uint
            label = "WTH_OVERRIDE_EFFICIENCY_ALG"
            for x in range(1):
                traceEntry.append(hexConcat(data, i, i+1)[0])
                i += 1
            ...
            for x in range(1):
                traceEntry.append(hexConcat(data, i, i+2)[0])
                i += 2
        elif attrEnum == 0xa0cb35b:
            #simpleType:uint
            label = "MEM_OVERRIDE_FREQ_LIMITATION"
            for x in range(1):
                traceEntry.append(hexConcat(data, i, i+1)[0])
                i += 1
            ...
            for x in range(1):
                traceEntry.append(hexConcat(data, i, i+2)[0])
                i += 2
        elif attrEnum == 0xa6640ef:
            #simpleType:uint
            label = "INTERPOSER_ECID"
            for x in range(1):
                traceEntry.append(hexConcat(data, i, i+8)[0])
                i += 8
            ...
            for x in range(1):
                traceEntry.append(hexConcat(data, i, i+4)[0])
                i += 4
        elif attrEnum == 0xa687574:
            #simpleType:uint
            label = "INTERPOSER_FEATURE_HW632898"
            for x in range(1):
                traceEntry.append(hexConcat(data, i, i+1)[0])
                i += 1
            ...
            for x in range(1):
                traceEntry.append(hexConcat(data, i, i+1)[0])
                i += 1
        elif attrEnum == 0xa7b26cf:
            #simpleType:uint
            label = "MRW_MAX_DDR_FREQ_ON_IOSCM"
            for x in range(1):
                traceEntry.append(hexConcat(data, i, i+2)[0])
                i += 2
            ...
            for x in range(1):
                traceEntry.append(hexConcat(data, i, i+1)[0])
                i += 1
        elif attrEnum == 0xaa99dde:
            #simpleType:uint
            label = "SYSTEM_WOV_DDS_CALIBRATION_ENABLE"
            for x in range(1):
                traceEntry.append(hexConcat(data, i, i+1)[0])
                i += 1
            ...
            attr, i=intConcat(data, i, i+4)
            if attr == 0x00000000:
                 traceEntry.append("CHECK_ATTN_AFTER_ISTEP_FAIL_DEFAULT")
            elif attr == 0x00000001:
                 traceEntry.append("CHECK_ATTN_AFTER_ISTEP_FAIL_NO")
            ...
            for x in range(1):
                traceEntry.append(hexConcat(data, i, i+1)[0])
                i += 1
        elif attrEnum == 0xada1fc2:
            #simpleType:uint
            label = "ODY_DISABLE_DRAM_WITH_BAD_DQ0"
            for x in range(1):
                traceEntry.append(hexConcat(data, i, i+1)[0])
                i += 1
            ...
            for x in range(1):
                traceEntry.append(hexConcat(data, i, i+1)[0])
                i += 1
        elif attrEnum == 0xb8b3f00:
            #simpleType:uint
            label = "REPLACED_BY_SPARE"
            for x in range(1):
                traceEntry.append(hexConcat(data, i, i+1)[0])
                i += 1
            ...
            for x in range(1):
                traceEntry.append(hexConcat(data, i, i+1)[0])
                i += 1
        elif attrEnum == 0xb8d2a23:
            #simpleType:uint
            label = "MEM_THERMAL_INIT_COMPLETE"
            for x in range(1):
                traceEntry.append(hexConcat(data, i, i+1)[0])
                i += 1
            ...
            for x in range(1):
                traceEntry.append(hexConcat(data, i, i+1)[0])
                i += 1
        elif attrEnum == 0xbbc3ceb:
            #simpleType:uint
            label = "WTH_OVERRIDE_CORE_COUNT_INDEX_ARRAY"
            traceEntry.append("[8]:")
            for x in range(8):
                traceEntry.append(hexConcat(data, i, i+1)[0])
                i += 1
            ...
            for x in range(1):
                traceEntry.append(hexConcat(data, i, i+1)[0])
                i += 1
        elif attrEnum == 0xc4be99d:
            #simpleType:uint
            label = "MSS_MRW_IDLE_PSMODE_ENTER_STR_TIME"
            for x in range(1):
                traceEntry.append(hexConcat(data, i, i+2)[0])
                i += 2
            ...
            for x in range(1):
                traceEntry.append(hexConcat(data, i, i+1)[0])
                i += 1
        elif attrEnum == 0xc4d3c24:
            #simpleType:uint
            label = "SBE_LOAD_BOOTLOADER_HBBL_SIZE"
            for x in range(1):
                traceEntry.append(hexConcat(data, i, i+8)[0])
                i += 8
            ...
            for x in range(8):
                traceEntry.append(hexConcat(data, i, i+1)[0])
                i += 1
        elif attrEnum == 0xc6cf6dd:
            #simpleType:uint
            label = "WTH_OVERRIDE_CORE_COUNT_INDEX"
            for x in range(1):
                traceEntry.append(hexConcat(data, i, i+1)[0])
                i += 1
            ...
            pass
        elif attrEnum == 0xd282763:
            #simpleType:uint
            label = "SPARE_CORES_DEPLOYED"
            for x in range(1):
                traceEntry.append(hexConcat(data, i, i+1)[0])
                i += 1
            ...
            for x in range(1):
                traceEntry.append(hexConcat(data, i, i+1)[0])
                i += 1
        elif attrEnum == 0xd29c2de:
            #simpleType:uint
            label = "SPARE_CORE_ACTIONS_DISABLED"
            for x in range(1):
                traceEntry.append(hexConcat(data, i, i+1)[0])
                i += 1
            ...
            for x in range(4):
                traceEntry.append(hexConcat(data, i, i+1)[0])
                i += 1
        elif attrEnum == 0xd36e7f1:
            #simpleType:uint
            label = "ODY_DQS_TRACKING_FAILED"
            for x in range(1):
                traceEntry.append(hexConcat(data, i, i+1)[0])
                i += 1
            ...
            for x in range(1):
                traceEntry.append(hexConcat(data, i, i+1)[0])
                i += 1
        elif attrEnum == 0xd3b25a9:
            #simpleType:uint
            label = "MSS_MRW_ENTER_STR_TIME"
            for x in range(1):
                traceEntry.append(hexConcat(data, i, i+2)[0])
                i += 2
            ...
            for x in range(1):
                traceEntry.append(hexConcat(data, i, i+1)[0])
                i += 1
        elif attrEnum == 0xdbb83fc:
            #simpleType:uint
            label = "ODY_DQS_TRACKING_HALF_DIMM_TARGET"
            for x in range(1):
                traceEntry.append(hexConcat(data, i, i+1)[0])
                i += 1
            ...
            for x in range(1):
                traceEntry.append(hexConcat(data, i, i+4)[0])
                i += 4
        elif attrEnum == 0xdca883d:
            #simpleType:uint
            label = "IQ_STATIC_DATA_ENABLE"
            for x in range(1):
                traceEntry.append(hexConcat(data, i, i+1)[0])
                i += 1
            ...
            for x in range(1):
                traceEntry.append(hexConcat(data, i, i+8)[0])
                i += 8
        elif attrEnum == 0xdfa0ab1:
            #simpleType:uint
            label = "ODY_DQS_TRACKING_MISSED_QUIESCE_COUNT"
            for x in range(1):
                traceEntry.append(hexConcat(data, i, i+1)[0])
                i += 1
            ...
            for x in range(1):
                traceEntry.append(hexConcat(data, i, i+4)[0])
                i += 4
        elif attrEnum == 0xe53583f:
            #simpleType:uint
            label = "HB_SETTINGS_OVERRIDE"
            for x in range(1):
                traceEntry.append(hexConcat(data, i, i+1)[0])
                i += 1
            ...
            for x in range(1):
                traceEntry.append(hexConcat(data, i, i+4)[0])
                i += 4
        elif attrEnum == 0xe712112:
            #simpleType:uint
            label = "RTG_SCAN_ORDER"
            for x in range(1):
                traceEntry.append(hexConcat(data, i, i+1)[0])
                i += 1
            ...
            for x in range(1):
                traceEntry.append(hexConcat(data, i, i+1)[0])
                i += 1
        elif attrEnum == 0xea0b51a:
            #simpleType:uint
            label = "POWERVS_P10_FW_VER"
            traceEntry.append("[3][3]:")
            for x in range(9):
                traceEntry.append(hexConcat(data, i, i+1)[0])
                i += 1
        elif attrEnum == 0xea3d478:
            #simpleType:uint
            label = "SBE_LOAD_BOOTLOADER_CHUNK_OFFSET"
            for x in range(1):
                traceEntry.append(hexConcat(data, i, i+8)[0])
                i += 8
            ...
            for x in range(1):
                traceEntry.append(hexConcat(data, i, i+1)[0])
                i += 1
        elif attrEnum == 0xed6c3e0:
            #simpleType:uint
            label = "DIMM_PREHEAT_POWER"
            traceEntry.append("[12]:")
            for x in range(12):
                traceEntry.append(hexConcat(data, i, i+4)[0])
                i += 4
            ...
            for x in range(1):
                traceEntry.append(hexConcat(data, i, i+1)[0])
                i += 1
        elif attrEnum == 0xf278a76:
            #simpleType:uint
            label = "MSS_MRW_MIN_DOMAIN_REDUCTION_TIME"
            for x in range(1):
                traceEntry.append(hexConcat(data, i, i+2)[0])
                i += 2
            ...
            for x in range(1):
                traceEntry.append(hexConcat(data, i, i+1)[0])
                i += 1
        elif attrEnum == 0xf578144:
            #simpleType:uint
            label = "EEPROM_VPD_ACTIVE_COPY"
            for x in range(1):
                traceEntry.append(hexConcat(data, i, i+1)[0])
                i += 1
            ...
            for x in range(1):
                traceEntry.append(hexConcat(data, i, i+1)[0])
                i += 1
        elif attrEnum == 0xf620eaa:
            #simpleType:uint
            label = "MSS_ODY_PASSED_SWIZZLE_DETECT"
            for x in range(1):
                traceEntry.append(hexConcat(data, i, i+1)[0])
                i += 1
            ...
            for x in range(1):
                traceEntry.append(hexConcat(data, i, i+1)[0])
                i += 1
        elif attrEnum == 0xf9d3311:
            #simpleType:uint
            label = "WOV_UNDERV_EXTENDED_MAX_10THPCT"
            for x in range(1):
                traceEntry.append(hexConcat(data, i, i+2)[0])
                i += 2
            ...
            for x in range(1):
                traceEntry.append(hexConcat(data, i, i+1)[0])
                i += 1
        elif attrEnum == 0xfafcbf2:
            #simpleType:uint
            label = "MAIL_MESSAGE_BITMAP"
            for x in range(1):
                traceEntry.append(hexConcat(data, i, i+4)[0])
                i += 4
            ...
            for x in range(1):
                traceEntry.append(hexConcat(data, i, i+1)[0])
                i += 1
        elif attrEnum == 0xfe2fc3a:
            #simpleType:uint
            label = "WTH_OVERRIDE_TEST_CORE_COUNT"
            for x in range(1):
                traceEntry.append(hexConcat(data, i, i+1)[0])
                i += 1

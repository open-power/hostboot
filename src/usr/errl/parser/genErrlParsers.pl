...
print "$PYoutputFileName is the new file";
open(PYFILE, ">", $PYoutputFileName) or die("Cannot open: $PYoutputFileName: $!");
print PYFILE "# The content of this file, srcdisplaydata.py, is automatically\n";
print PYFILE "# generated by src/usr/errl/parser/genErrlParsers.pl and output to\n";
print PYFILE "# obj/genfiles/plugins/srcdisplaydata.py.\n\n";

print PYFILE "# At this time, the generated file must be manually copied from the\n";
print PYFILE "# obj/genfiles/plugins directory to the src/usr/errl/parser/ebmc directory and\n";
print PYFILE "# then manually checked in to be picked up by the Hostboot build.\n\n";

print PYFILE "# To pull the parser change into a BMC image, update the commit pointer in the\n";
print PYFILE "# openbmc project's meta-openpower/recipes-phosphor/logging/hostboot-pel-parsers_git.bb\n";
print PYFILE "# file to reference the Hostboot commit with the change.\n\n";

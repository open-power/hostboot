...
srcInfo = {
            ...
            0x51703: {    "devdesc": "Timing information from the boot sequence",
            ...
            0x647DB: {    "devdesc": "Secure Protected section of HB_HLL is too small",
            ...
            0x648DB: {    "devdesc": "Bad EYE_CATCHER in HB_HLL_Metadata_t",
                           "moduleid": "MOD_SPNORRP_PROCESS_HB_HLL",
            ...
            0xB8386: {    "devdesc": "Bad eyecatcher in the new data",
            ...
            0xB9993: {    "devdesc": "Could not find attribute data in pnor",
            ...
            0xC2914: {    "devdesc": "An uneven number of spare core bits were set in the partial good for a chip in fused mode.",
            ...
            0xC2A15: {    "devdesc": "Chip didn't have enough present cores to satisfy requested number of spares",
            ...
            0xC2B15: {    "devdesc": "Chip had spare core attributes set prior to spare selection taking place",
                           "moduleid": "MOD_SELECT_SPARE_CORES",
            ...
            0x160227: {    "devdesc": "A memory range could not be block-mapped",
            ...
            0x160623: {    "devdesc": "Error processing group for HLL Mgr",
            ...
            0x161527: {    "devdesc": "mm_block_unmap failed for a memory range",
                           "moduleid": "Util::UTIL_TCE_CLEAR_MEM_RANGE",
                           "reasoncode": "Util::UTIL_TCE_BLOCK_UNMAP_FAIL",
                           "userdata1":  "Starting virtual address of pages to be removed",
                           "userdata2":  "Return Code from mm_block_unmap",
            ...
            0x161620: {    "devdesc": "Error calling mm_block_map",
                           "moduleid": "Util::UTIL_HLL_MANAGE_PHYP",
                           "reasoncode": "Util::UTIL_MM_BLOCK_MAP_FAILED",
                           "userdata1":  "Physical address being mapped",
                           "userdata2":  "mapSize",
                      },
            0x161621: {    "devdesc": "Error calling mm_block_map for HLL Mgr",
            ...
            0x161720: {    "devdesc": "Error calling mm_block_unmap",
                           "moduleid": "Util::UTIL_HLL_MANAGE_PHYP",
                           "reasoncode": "Util::UTIL_MM_BLOCK_UNMAP_FAILED",
                           "userdata1":  "Address being removed",
                           "userdata2":  "rc from mm_block_unmap",
                      },
            0x161722: {    "devdesc": "Error calling mm_block_unmap for HLL Mgr",
            ...
            0x16261F: {    "devdesc": "Problem with XZ compression initialization",
                           "moduleid": "Util::UTIL_HLL_DECOMPRESS_LID",
                           "reasoncode": "Util::UTIL_HLL_DECOMPRESS_FAIL_INIT",
                           "userdata1":  "i_size Size of the input data to decompress",
                           "userdata2":  "io_size Size of the output buffer passed in",
                      },
            0x16271F: {    "devdesc": "Problem with XZ decompression",
                           "moduleid": "Util::UTIL_HLL_DECOMPRESS_LID",
                           "reasoncode": "Util::UTIL_HLL_DECOMPRESS_FAILED",
                           "userdata1":  "ret XZ decompression return code",
                           "userdata2":  "i_size Size of the input data to decompress",
                      },
            0x16281F: {    "devdesc": "Decompressed LID is unexpectedly empty",
                           "moduleid": "Util::UTIL_HLL_DECOMPRESS_LID",
                           "reasoncode": "Util::UTIL_HLL_DECOMPRESS_EMPTY",
                           "userdata1":  "i_size Size of the input data to decompress",
                           "userdata2":  "io_size Size of the output buffer passed in",
                      },
            0x162923: {    "devdesc": "Error processing group for HLL Mgr",
                           "moduleid": "Util::UTIL_HLL_INIT_METADATA",
            ...
            0x162C26: {    "devdesc": "Secure hash failure on lid",
            ...
            0x162D24: {    "devdesc": "Versioning incompatibility",
                           "moduleid": "Util::UTIL_HLL_PARSE_TOC",
            ...
            0x162E25: {    "devdesc": "Size miscompare on hashBlob",
                           "moduleid": "Util::UTIL_HLL_LOADLIDS",
            ...
            0x175A13: {    "devdesc": "Message from FSP. An invalid message queue ID or mesage type was sent to the FSP.",
            ...
            0x177243: {    "devdesc": "kernal/timemgr.c has incorrect timebase compared to core frequency attribute",
            ...
            0x177344: {    "devdesc": "All available spare cores have been deployed",
            ...
            0x177415: {    "devdesc": "The primary SBE HW Keys' hash does not match the backup SBE HW Keys' hash, so we cannot guarantee platform security for the system",
                           "moduleid": "ISTEP::MOD_VALIDATE_SECURITY_SETTINGS",
                           "reasoncode": "ISTEP::RC_PRIMARY_PROC_SIGNING_MODE_MISMATCH",
                           "userdata1":  "Primary Processor Target",
                      },
            0x17FEFE: {    "devdesc": "Could not get the correct value for an attr in MPIPL after a concurrent code update",
            ...
            0x1D5895: {    "devdesc": "CRC mismatch between redundant SPD copies.",
            ...
            0x1E3531: {    "devdesc": "Received notice of error during node exchange from another node",
                           "moduleid": "MOD_NCT_NODE_SYNC",
                           "reasoncode": "RC_NCEX_RECEIVED_ABORT_MSG",
                           "userdata1":  "Bitfield representing which nodes reported errors (LSB is node0, next bit node1, etc)",
                           "userdata2":  "0",
                      },
            ...
            0x22190B: {    "devdesc": "Bad RC from p9_xip_get_section",
            ...
            0x222808: {    "devdesc": "Invalid global variables for HBBL data",
                           "moduleid": "SBE_GET_TARGET_INFO_STATE",
                           "reasoncode": "SBE_INVALID_HBBL_DATA",
                           "userdata1":  "g_hbbl_data_size",
                           "userdata2":  "g_hbbl_data_ptr",
                      },
            0x222816: {    "devdesc": "Unable to create a valid pointer to HBBL data",
                           "moduleid": "SBE_PRELOAD_PNOR_SECTIONS",
                           "reasoncode": "SBE_INVALID_HBBL_DATA",
                           "userdata1":  "g_hbbl_data_size",
                           "userdata2":  "g_hbbl_data_ptr",
                      },
            0x222908: {    "devdesc": "The global variable for the HBBL V1 and V3 security headers is invalid",
                           "moduleid": "SBE_GET_TARGET_INFO_STATE",
                           "reasoncode": "SBE_INVALID_HBBL_SECURITY_HEADERS",
                           "userdata1":  "g_hbbl_v1_v3_headers_ptr",
                           "userdata2":  "SBH_HBBL_SECTION_SIZE",
                      },
            0x222916: {    "devdesc": "Unable to create a valid pointer to HBBL V1 and V3 security headers",
                           "moduleid": "SBE_PRELOAD_PNOR_SECTIONS",
                           "reasoncode": "SBE_INVALID_HBBL_SECURITY_HEADERS",
                           "userdata1":  "g_hbbl_v1_v3_headers_ptr",
                           "userdata2":  "SBH_HBBL_SECTION_SIZE",
                      },
            0x222A0B: {    "devdesc": "Did not find a Section Marker string in customized image",
                           "moduleid": "SBE_CUSTOMIZE_IMG",
                           "reasoncode": "SBE_SECTION_MARKER_NOT_FOUND",
                           "userdata1":  "i_SourceBfrLen",
                           "userdata2":  "Unused",
                      },
            0x222B08: {    "devdesc": "Unexpected Secure Version found in SBE Image",
                           "moduleid": "SBE_GET_TARGET_INFO_STATE",
            ...
            0x260727: {    "devdesc": "Software problem, Failed to set DIMM power utilization points",
                           "moduleid": "HTMGT_MOD_UPDATE_DIMM_POWER_UTIL",
                           "reasoncode": "HTMGT_RC_SAVE_TO_ATTRIBUTE_FAIL",
            ...
            0x262328: {    "devdesc": "Invalid OCMB port burst/clock data",
            ...
            0x26C007: {    "devdesc": "PM Complex has been put in reset for code update",
                           "moduleid": "HTMGT_MOD_OCC_RESET",
            ...
            0x287B1B: {    "devdesc": "Could not allocate request for Ody SBE dump",
                           "moduleid": "SBEIO_ODY_RECOVERY",
            ...
            0x332F26: {    "devdesc": "WOF tables header version not supported",
                           ...
                           "userdata1[32:63]":  "Supported header version Each nibble represents different version support.",
                      },
            ...
            0x342a02: {    "devdesc": "Bad SB signing mode",
                           "moduleid": "Bootloader::MOD_BOOTLOADER_MAIN",
            ...
            0x342b02: {    "devdesc": "Mismatch between v1 and v3 header protected payload size",
                           "moduleid": "Bootloader::MOD_BOOTLOADER_MAIN",
            ...
            0x342c02: {    "devdesc": "Expected V3 header appended to HBB but found none",
                           "moduleid": "Bootloader::MOD_BOOTLOADER_MAIN",
            ...
            0x421406: {    "devdesc": "The Odyssey code update FSM requested to delayed deconfigure this OCMB.",
                           "moduleid": "MOD_ODY_UPD_FSM",
            ...
            0x47044F: {    "devdesc": "Software problem, bad PLDM response from BMC",
            ...
            0x472350: {    "devdesc": "Value we are trying to set BIOS attr with is out of acceptable range of values.",

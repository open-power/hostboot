...
def gardTypeToStr(i_gardType):
    gardTypes = {"00": "NoGard", "e6": "Predictive", "e3": "Fatal"}
...
def mruCalloutToStr(i_mruCallout):
    mruCallouts = {0x70: "CALLOUT_RANK", 0x71: "CALLOUT_ALL_MEM"}
...
def tdTypeToStr(i_tdType):
    ...
    #       prdfMemTdQueue.H
    tdTypes = {0: "VCM", 1: "RRD", 2: "DSD", 3: "TPS", 0xF: "Invalid Event"}
    ...
    def UdParserPrdfCapData(ver, data):
        ...
        while True:
            ...
            for x in range(numIDs):
                ...
                elif hexId == hashString(
                    "TDCTLR_STATE_DATA_START"
                ) or hexId == hashString("TDCTLR_STATE_DATA_END"):

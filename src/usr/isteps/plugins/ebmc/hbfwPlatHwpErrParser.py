...
def hbfwErrLookupHwpRc(ver, data):
    ...
    RCDesc={
            ...
            0xd53d8c: [ "RC_MSS_EMPTY_PDA_VECTOR",
                        "Indicates a that a vector was empty when a procedure was called" ],
            0x6c9fe6: [ "RC_MSS_FAILED_SPD_REVISION_FALLBACK",
            ...
            0x4a1f8c: [ "RC_MSS_INVALID_HYBRID_MODULE",
                        "Received an invalid or unsupported hybrid media (SPD byte 3, bits [6:4]) for a specified hybrid modue (SPD byte 3, bit [7])" ],
            ...
            0x1f6e32: [ "RC_MSS_INVALID_SPD_PARAMETER_RECEIVED",
                        "Unable to fall back SPD decoder to the highest decoded revision. Most likely a programming error." ],
            0x6815a9: [ "RC_MSS_INVALID_DIMM_MODULE_RECEIVED_FOR_SPD_REV_FALLBACK",
                        "Unable to fall back SPD decoder to the highest decoded revision for particular DIMM module. Most likely a programming error or bad SPD." ],
            0x7449c5: [ "RC_MSS_INVALID_SPD_RANK",
                        "Invalid rank passed into attribute engine. May be due to problem in SPD." ],
            ...
            0xc13196: [ "RC_MSS_PDA_DRAM_OUT_OF_RANGE",
                        "Indicates a DRAM passed to the PDA code is out of range" ],
            ...
            0x296448: [ "RC_MSS_UNEXPECTED_VALUE_SEEN",
                        "Invalid value seen versus the expected value wanted" ],
            ...
            0xdc69c9: [ "RC_MSS_SPD_REV_ENCODING_LEVEL_NOT_SUPPORTED",
                        "SPD revision on byte 1 (bits 7~4) has a unsupported encoding level that is greater than the largest decoded SPD decoder. There is no backward compatible revision to fallback to. This could be bad SPD or a programming error." ],
            ...
            0x84819b: [ "RC_MSS_INVALID_DRAM_WIDTH",
                        "Code only supports x4 and x8 drams at this time" ],
            0x098ebb: [ "RC_MSS_INVALID_PAGE_SIZE",
                        "Invalid page size" ],
            0x4e262b: [ "RC_MSS_INVALID_OMI_POSITION",
                        "An invalid OMI position was found in FIR unmask function" ],
            0xaa9962: [ "RC_MSS_PLUG_RULES_SINGLE_DDIMM_IN_WRONG_SLOT",
                        "A single DIMM was plugged into a secondary channel slot without one plugged into the primary channel slot." ],
            0xef2f1a: [ "RC_MSS_MIN_UTILIZATION_ERROR",
                        "The input utilization is less than the minimum utilization allowed." ],
            0x3813f4: [ "RC_MSS_UNKNOWN_DIMM_SPD_KEY",
                        "DIMM SPD key from DIMM SPD was not recognized in plug rule enforcement function. The key is the manufacturing ID, the DIMM height, and the DIMM size." ],
            0x941a1d: [ "RC_MSS_UNSUPPORTED_SPD_REVISION",
                        "DIMM SPD revision is older than least supported revision." ],
            0x349af5: [ "RC_MSS_NON_CURRENT_SPD_REVISION",
                        "DIMM SPD revision is not current, and could be updated." ],
            0x92c209: [ "RC_MSS_UNSUPPORTED_SPD_COMBINED_REVISION",
                        "DIMM SPD combined revision is older than least supported revision." ],
            0xb42dae: [ "RC_MSS_NON_CURRENT_SPD_COMBINED_REVISION",
                        "DIMM SPD combined revision is not current, and could be updated." ],
            0xb2f99a: [ "RC_OCMB_IS_NOT_EXPLORER",
                        "Procedure: exp_omi_init.C The Explorer O0DID was not read." ],
            0xc5ebbb: [ "RC_EXPLR_OMI_TEMPLATE_ERR",
                        "Procedure: exp_omi_init.C Required template not supported" ],
            ...
            0xbd186b: [ "RC_MSS_EXP_DRAMINIT_BAD_NUM_RANKS",
                        "Bad number of ranks were passed in the bad bits functionality" ],
            ...
            0x81e986: [ "RC_MSS_EXP_I2C_FW_STATUS_CODE_FAILED",
                        "Explorer status code for command ID EXP_FW_STATUS did not return SUCCESS" ],
            0x86716c: [ "RC_MSS_EXP_I2C_FW_BOOT_CONFIG_STATUS_CODE_INVALID",
                        "Unexpected Explorer status code returned during OMI link training pattern handshake. Expected FW_BUSY, but received STATUS_CODE in FFDC data" ],
            0x0a607c: [ "RC_MSS_EXP_I2C_FW_STATUS_BUSY",
                        "Received FW_BUSY status after polling timeout for command ID EXP_FW_STATUS" ],
            0x32bffe: [ "RC_MSS_EXP_I2C_WRONG_BOOT_STAGE",
                        "Received incorrect boot stage from command ID EXP_FW_STATUS" ],
            0xb1ce2f: [ "RC_MSS_EXP_I2C_POLLING_TIMEOUT",
                        "Polling the explorer I2C slave interface for an ACK timed out." ],
            0x572db0: [ "RC_MSS_EXP_I2C_FW_STATUS_INVALID_SIZE",
                        "Received incorrect EXP_FW_STATUS data size" ],
            0x591a9a: [ "RC_MSS_EXP_STATUS_POLLING_TIMEOUT",
                        "Polling the explorer for successful return code timed out." ],
            ...
            0xc469e7: [ "RC_EXP_MAINT_DO_STEER_INPUT_OUT_OF_RANGE",
            ...
            0xa4fa07: [ "RC_EXP_OMI_BUMP_SL_WORKAROUND_ERROR",
            ...
            0x92733d: [ "RC_PMIC_VOLTAGE_RANGE_SETTING_OUT_OF_RANGE",
            ...
            0x228066: [ "RC_PMIC_DIMM_SPD_UNSUPPORTED_MODULE_HEIGHT",
                        "The module_height attribute SPD of this DIMM was not identified as 1U or 2U. Other heights (4U) are not supported at this time." ],
            ...
            0xdeea27: [ "RC_PMIC_EXPECTED_FOUR_PMICS",
                        "The presence of GPIO/ADC devices implies we should have a redundant PMIC configuration. Expected 4 PMICs, but platform did not provide 4." ],
            0x41773b: [ "RC_VIN_BULK_BELOW_TOLERANCE",
                        "The VIN_BULK read by the PMIC ADC was below the minimum tolerance." ],
            0x2b57f5: [ "RC_INVALID_NUMBER_OF_TARGETS",
                        "Expected 4 GENERICI2CSLAVE targets and at least 2 PMICs, otherwise, we can not properly enable the PMICs on the 4U DIMM." ],
            0xad3ca4: [ "RC_PMIC_MISMATCHING_REDUNDANCY_ATTRS",
                        "PMIC0_REDUNDANCY and PMIC1_REDUNDANCY must match (both 0 or both 1). A configuration doesn't exist where only 1 PMIC has redundancy." ],
            ...
            0xb2a8ac: [ "RC_MSS_PMIC_I2C_POLLING_TIMEOUT",
            ...
            0xe1a2af: [ "RC_SPCWKUP_CODE_BAD_ENTITY",
                        "An invalid entity (eg besides FSP, OCC, or PHYP ENUM) was passed to p9_cpu_special_wakeup" ],
            0x1baaf8: [ "RC_SPCWKUP_CODE_BAD_OP",
                        "An invalid operation (eg besides Set or Clear ENUM) was passed to p9_cpu_special_wakeup" ],
            0x24b00f: [ "RC_SYSTEM_IN_CHECKSTOP_STATE",
                        "System is in Checkstop state. Attempt to special wakeup a core will not succeed. Hence, HWP will not even attempt for core special wakeup." ],
            ...
            0x61e7c2: [ "RC_INTERNAL_SPLWKUP_IS_POSSIBLE",
                        "An internal RC suggesting that special wakeup request can be serviced. It is based on the fact that the QME servicing the core is active." ],
            ...
            0xd6c1b4: [ "RC_MSS_EFF_GROUPING_UNABLE_TO_GROUP",
                        "p10_mss_eff_grouping is unable to group at least one MCC on this chip based on the specified memory interleaving and mirroring rules. This is a memory plugging error. Refer to memory plugging rules." ],
            ...
            0xa71951: [ "RC_MSS_EFF_GROUPING_SMF_NOT_ENABLED",
                        "Requirements to enable a secure memory space not met: ATTR_PROC_SMF_BAR_SIZE is set but ATTR_SMF_CONFIG is not enabled." ],
            ...
            0xb5cdc6: [ "RC_MSS_EFF_GROUPING_NM_REGION_MAP_ERROR",
                        "p10_mss_eff_grouping did not find an available region to map non-mirrored group" ],
            0x6e44f7: [ "RC_MSS_EFF_GROUPING_M_REGION_MAP_ERROR",
                        "p10_mss_eff_grouping did not find an available region to map mirrored group" ],
            0xae13e3: [ "RC_MSS_EFF_GROUPING_INVALID_GROUP_SIZE",
                        "Can't locate given Group size in the GROUP_SIZE_TABLE in order to determine MCFGP/MCFGPM Group size value (bits 13:23)." ],
            0x65e3b4: [ "RC_MSS_EFF_GROUPING_INVALID_MCC_CONFIG",
                        "Invalid number in group for MCC 0/1 of the MC (MI). The combination can not be found in the Channel Per Group table." ],
            ...
            0x482975: [ "RC_MVPD_RING_REDUNDANT_DATA",
                        "MVPD ring has redundant data (Not a bug. Info to caller.)" ],
            ...
            0x101b05: [ "RC_MSS_MRW_FREQ_SIZE_CHANGED",
                        "Size of MSS_MRW_FREQS value in VPD has changed and code hasn't been updated" ],
            0xf06c0e: [ "RC_MSS_ERROR_CALCULATING_CAS_LATENCY_VECTOR",
                        "Code error setting the cas_latency. Number of cas_latencies per MCS does not equal functional ports found" ],
            0x89cffe: [ "RC_MSS_MRW_FREQ_MAX_FREQ_EMPTY_SET",
                        "When considering the frequencies in the MRW and the max supported frequencies based on DIMM config (MAX_ALLOWED_DIMM_FREQ), there are no applicable frequencies remaining If sync mode required, frequencies have to match a nest frequency" ],
            0xcf1c14: [ "RC_MSS_NO_SUPPORTED_FREQ",
                        "When considering the frequencies in the MRW and the max supported frequencies based on DIMM config, there are no applicable frequencies remaining If sync mode required, frequencies have to match a nest frequency" ],
            0x375654: [ "RC_MSS_FREQ_TO_NEST_FREQ_RATIO_TOO_LARGE",
                        "Case when mss_freq to nest freq is above the maximum allowed." ],
            0x20ca3b: [ "RC_MSS_FREQ_OR_NEST_FREQ_IS_ZERO",
            ...
            0x6f6e83: [ "RC_PROCPM_AVSBUS_VOLTAGE_TIMEOUT",
                        "A timeout occured reading/writing voltage from an AVSBus interface" ],
            0xb5f060: [ "RC_PROCPM_AVSBUS_IDLEFRAME_TIMEOUT",
            ...
            0x6e3e35: [ "RC_P10_RAM_NOT_SETUP_ERR",
                        "RAM is not setup as active before doing ram or cleanup" ],
            0x493859: [ "RC_P10_RAM_INACTIVE_THREAD_HW542214",
            ...
            0x7ad22a: [ "RC_OCC_CONTROL_NONSTART_DUE_TO_RISCWATCH",
                        "The OCC PPC405 cannot be started due to a conflicting RISCWatch operation that keeps it in the halt state." ],
            ...
            0x3c277f: [ "RC_SB_MSG_SET_POLL_THRESHOLD_ERR",
                        "Selfboot kernel has not indicated boot complete within alotted timeout. (SB_MSG bit 0 not set)" ],
            ...
            0xd615d3: [ "RC_P10_FAB_IOVALID_DL_NOT_TRAINED_RETRAIN_NONE_ERR",
                        "Link DL training did not complete successfully, both halves of link pair are incapable of training." ],
            0x672ccf: [ "RC_P10_FAB_IOVALID_DL_NOT_TRAINED_RETRAIN_HALF_ERR",
                        "Link DL training did not complete successfully, attempt retraining on half link basis." ],
            0xb622a5: [ "RC_P10_FAB_IOVALID_TL_NOT_TRAINED_ERR",
            ...
            0x117290: [ "RC_P10_L2_FLUSH_PURGE_REQ_OUTSTANDING",
                        "A previous L2 purge request has not finished" ],
            ...
            0x715afb: [ "RC_XIPC_MVPD_INVALID_RECORD_DATA",
                        "VPD ring's record data is invalid" ],
            0xf6f03d: [ "RC_XIPC_MVPD_FIELD_SIZE_MESS",
                        "MVPD field size mess" ],
            0x5866d2: [ "RC_XIPC_MVPD_AW_FIELD_VALUE_ERR",
                        "Out of range value observed in MVPD AW keyword" ],
            ...
            0xe21e47: [ "RC_XIPC_RINGID_CHECK_RINGID_ERROR",
                        "ringid_check_ringId() failed" ],
            ...
            0x62b8e3: [ "RC_XIPC_FAPI_ATTR_SVC_FAIL",
                        "FAPI attribute service failed" ],
            ...
            0x29f44f: [ "RC_XIPC_TARGET_OVLY_RAW_RING_LENGTH_MISMATCH",
                        "Target ring and overlay raw ring lengths do not match" ],
            0x9387d5: [ "RC_XIPC_MVPD_OVLY_RING_HEADER_MISMATCH",
                        "Mvpd and Ovly ring header mismatch" ],
            0x6bcb91: [ "RC_XIPC_RS4_COMPRESS_ERROR",
                        "_rs4_compress() failed" ],
            ...
            0x5dc7fd: [ "RC_P10_DOWNSTREAM_TMPL1_REQUIRED_ERR",
                        "Procedure: p10_omi_init Downstream template 1 required" ],
            0x692c21: [ "RC_P10_DOWNSTREAM_TMPL4OR7_REQUIRED_ERR",
                        "Procedure: p10_omi_init Downstream template 4 or/and 7 is required" ],
            ...
            0x983d8d: [ "RC_QME_IMG_NOT_FOUND_IN_HW_IMG",
                        "QME Image not found in hardware image. Note: 0xFFFFFFFF in field MAX_ALLOWED_SIZE is an invalid size suggesting that image section is not found" ],
            ...
            0x6027ee: [ "RC_P10_PGPE_AUX_TASK_BUILD_FAIL",
                        "hcode image build procedure failed to update PGPE Aux Task region of HOMER. Note: 0xFFFFFFFF in field MAX_ALLOWED_SIZE is an invalid size suggesting that image section is not found" ],
            0xfdfaa6: [ "RC_QME_RING_SECTN_EXTRACTION_FAIL",
                        "hcode image build procedure failed to extract scan rings within QME image" ],
            ...
            0xff4c7f: [ "RC_REFRESH_SCOM_UPDATE_FAIL",
                        "hcode image build procedure failed to create restore entry for L3 refresh timer divider register" ],
            0x102563: [ "RC_PSTATE_SUP_STRUCT_SIZE_ERR",
                        "hcode image build procedure failed due to P-State parameter block super struct size error" ],
            0x523ce8: [ "RC_OCC_PARAM_BLOCK_SIZE_ERR",
                        "hcode image build procedure failed due to OCC P-State parameter block struct size error" ],
            0x4171da: [ "RC_PARAM_WOF_TABLE_SIZE_ERR",
                        "hcode image build procedure failed due to WOF Table exceeding permissible size limit" ],
            0xb78312: [ "RC_CORE_CMN_RING_LAYOUT_ERR",
                        "hcode image build procedure failed to layout core common rings" ],
            0x166717: [ "RC_CORE_CMN_RING_OVRD_LAYOUT_ERR",
                        "hcode image build procedure failed to layout core common override rings" ],
            0xf99ae9: [ "RC_CORE_SPEC_RING_LAYOUT_ERR",
                        "hcode image build procedure failed to layout core common override rings" ],
            0xa1ce29: [ "RC_FAILED_TO_CALCULATE_CORE_REPAIR_RING",
                        "hcode image build procedure failed to determine max size of repair ring pair" ],
            0xce2599: [ "RC_QUAD_CMN_RING_LAYOUT_ERR",
                        "hcode image build procedure failed to layout quad common rings" ],
            0x9b7925: [ "RC_QUAD_CMN_RING_OVRD_LAYOUT_ERR",
                        "hcode image build procedure failed to layout quad common override rings" ],
            0x13a940: [ "RC_QUAD_SPEC_RING_LAYOUT_ERR",
                        "hcode image build procedure failed to layout quad spec rings" ],
            0x20c79d: [ "RC_NCU_RNG_SCOM_SAVE_FAIL",
                        "hcode image build procedure failed to save SCOM restore entry for NCU RNG BAR register" ],
            0xfb33f2: [ "RC_L2_RD_EPS_SCOM_SAVE_FAIL",
                        "hcode image build procedure failed to save SCOM restore entry for EX_L2_RD_EPS_REG register" ],
            0x69ec10: [ "RC_L2_WR_EPS_SCOM_SAVE_FAIL",
                        "hcode image build procedure failed to save SCOM restore entry for EX_L2_WR_EPS_REG register" ],
            0x64f5df: [ "RC_L3_RD_EPS_SCOM_SAVE_FAIL",
                        "hcode image build procedure failed to save SCOM restore entry for EX_L3_RD_EPS_REG register" ],
            0x4bcc01: [ "RC_L3_WR_EPS_SCOM_SAVE_FAIL",
                        "hcode image build procedure failed to save SCOM restore entry for L3_RD_EPS_REG" ],
            0xfa5e56: [ "RC_P10_PGPE_AUX_TASK_BIN_SIZE_ERROR",
                        "hcode image build procedure failed to build PPMR region due to a bad size of auxiliary task binary" ],
            ...
            0x18e01f: [ "RC_URMOR_RESTORE_ENTRY_FAILED",
                        "hcode image build procedure failed to create URMOR restore entry. It is meant for test and debug environment." ],
            0x3ae858: [ "RC_SELF_SAVE_API_FAILED",
                        "API call for creating SPR self save entry failed. It is meant for test and debug environment." ],
            0x6dadf4: [ "RC_BAD_UNSECURE_HOMER_VALUE",
                        "Attribute ATTR_UNSECURE_HOMER_ADDRESS is initialized with bad value. Address is either not aligned with 2MB boundary or b15 of of address value is not 0" ],
            ...
            0xe8eab2: [ "RC_XIP_SECTION_APPEND_APPEND_RC",
                        "Error calling p9_xip_section_append when running p9_xip_append" ],
            0x7b8738: [ "RC_XIP_SECTION_APPEND_SIZE_RC",
                        "Error calling p9_xip_section_append when running p9_xip_image_size" ],
            ...
            0x76e384: [ "RC_CORECACHE_CLK_CTRL_TIMEOUT",
                        "core/cache clock start/stop timed out." ],
            0xa353f8: [ "RC_P10_OMI_SETUP_BARS_INVALID_BAR",
            ...
            0x72ca6f: [ "RC_EXTRACT_SBE_RC_PROGRAM_INTERRUPT",
                        "Program interrupt promoted Action:Retrigger IPL or HRESET [RESTART_SBE]" ],
            0xf43665: [ "RC_EXTRACT_SBE_RC_INST_STORE_INTR",
                        "Instruction storage interrupt Action:Retrigger IPL or HRESET [RESTART_SBE]" ],
            ...
            0x4292c9: [ "RC_EXTRACT_SBE_RC_ADDR_NOT_RECOGNIZED",
                        "Address scope out of range Action:Retrigger IPL or HRESET [RESTART_SBE]" ],
            ...
            0x08a345: [ "RC_EXTRACT_SBE_RC_BRANCH_TO_SEEPROM_FAIL",
                        "Branch to SEEPROM didn't happen Action:No recovery action possible to correct this error [NO_RECOVERY_ACTION]" ],
            ...
            0x917162: [ "RC_EXTRACT_SBE_RC_SPI_ECC_ERR_NONSECURE_MODE",
                        "There are 2 bit flips in read data which cannot be corrected Action:Update of SEEPROM required or switch seeprom [REIPL_UPD_SEEPROM]" ],
            ...
            0xb4a5c5: [ "RC_EXTRACT_SBE_RC_UNKNOWN_ERROR",
                        "Unknown error has occured, So debug has to be done to understand the error Action: No recovery action [NO_RECOVERY_ACTION]" ],
            ...
            0xf0efcd: [ "RC_PSTATE_PB_POUNDV_WOF_CF6_ERROR",
            ...
            0xe67ed8: [ "RC_PSTATE_PB_BIASED_POUNDV_WOF_CF6_ERROR",
            ...
            0x556444: [ "RC_PSTATE_PB_CORE_FLOOR_FREQ_GT_CF6_FREQ",
                        "The core floor frequency is greater than ultra turbo freq." ],
            0x9082c1: [ "RC_PSTATE_PB_FREQ2PS_LT_PSTATE_MIN_ERROR",
                        "The calculated Pstate is less than the allowed minimum.." ],
            0xb49abf: [ "RC_PSTATE_PB_SAFE_FREQ_GT_CF6_FREQ",
                        "The calculated Save Mode frequency, after uplifting to account for VDM droop events, is above the UltraTurbo frequency of the part." ],
            ...
            0x7400c1: [ "RC_PSTATE_PB_UT_PSTATE0_FREQ_MISMATCH",
                        "The computed system pstate0 frequency attribute does not match with the UltraTurbo frequency for this part. This indicates the parts from different sorts may be plugged into the machine." ],
            0x01b70b: [ "RC_PSTATE_PB_FMAX_ZERO_WHEN_ENABLED",
                        "With ATTR_SYSTEM_FMAX_ENABLE being set, the necessary VPD #V Fmax frequency is 0." ],
            0x9cfb31: [ "RC_PSTATE_PB_UT_NOT_REGION6",
                        "The UltraTurbo frequency must be at or above the VPD #V CF6 frequency." ],
            0x5d8d20: [ "RC_PSTATE_PB_FMAX_ZERO_UT_INTERPOLATION",
                        "Placing a UltraTurbo frequency above CF6 requires CF7 to be non-zero." ],
            0x7642bb: [ "RC_PSTATE_PB_STRETCH_REGION_LACKS_STEPS",
                        "The stretch region necessary to place Pstate 0 in CF7 does not have 2 or more 16.667 frequency steps." ],
            ...
            0x38f9cc: [ "RC_P10_MSS_NO_SUPPORTED_FREQ",
                        "When considering the frequencies in the MRW and the max supported frequencies based on DIMM config, there are no applicable frequencies remaining" ],
            ...
            0x26a13f: [ "RC_P10_ADU_UTILS_INVALID_ARGS",
                        "There is an invalid argument (misaligned address or address out of the fabric address range) passed to the adu access or adu setup procedure Procedure: p10_adu_utils" ],
            ...
            0x64e2ba: [ "RC_P10_ADU_STATUS_REG_BAD_BUSY_STATE",
                        "The ALTD_STATUS_REGISTER contains an unexpected busy state after waiting a sufficient amount of time; either the busy bit is still set when the handler expects it to be clear, or the busy bit remained clear when the handler expects it to be set. Procedure: p10_adu_utils" ],
            ...
            0xc0f5ea: [ "RC_P10_CHIPLET_FABRIC_SCOMINIT_INVALID_IOHS_LINK",
                        "Unable to map iohs link when configuring fabric station registers." ],
            0x116dad: [ "RC_P10_CHIPLET_FABRIC_SCOMINIT_INVALID_HW543384_WAR_MODE",
                        "Invalid workaround selected for HW543384" ],
            ...
            0x55fa9a: [ "RC_P10_SMP_LINK_FIRS_IOHS_NOT_SMP",
                        "The requested IOHS target is not figured as an SMP link. This is a pre-requisite to setup the related FIR registers." ],

...
def hbfwErrLookupHwpRc(ver, data):
    ...
    RCDesc={
            0x009d2e: [ "RC_ODY_DRAMINIT_TRAINING_TIMEOUT",
                        "Ody draminit training poll timed out. mail message bitmap info [mail_message : bit no (left to right)] END_OF_INITILIAZATION : 0 END_OF_FINE_WRITE_LEVELING : 1 END_OF_READ_ENABLE_TRAINING : 2 END_OF_RD_DLY_CNTR_OPT : 3 END_OF_WR_DLY_CNTR_OPT : 4 END_OF_2D_RD_DLY_V_CNTR_OPT : 5 END_OF_2D_WR_DLY_V_CNTR_OPT : 6 END_OF_MAX_RD_LAT_TRAINING : 7 END_OF_RD_DQ_DSKEW_TRAINING : 8 TRAINING_STAGE_RESERVED : 9 END_OF_CS_CA_TRAINING : 10 END_OF_RCD_QCS_QCA_TRAINING : 11 END_OF_LRDIMM_MREP_TRAINING : 12 END_OF_LRDIMM_DWL_TRAINING : 13 END_OF_LRDIMM_MRD_TRAINING : 14 END_OF_LRDIMM_MWD_TRAINING : 15 GEN_WRT_NOISE_SYN : 16 END_OF_MPR_RD_DLY_CNTR_OPT : 17 END_OF_WR_LVL_COARSE_DLY : 18 UNKNOWN_MAJOR_MESSAGE : 19 SUCCESSFUL_COMPLETION : 20 FAILED_COMPLETION : 21" ],
            ...
            0x01dddb: [ "RC_MSS_CHANNEL_MIRROR_SETTINGS_MISMATCH_RANK0",
                        "Mirroring settings mismatch between channels in DDR5 SPD byte 365" ],
            0x0243a8: [ "RC_ODY_DRAMINIT_SMBUS_SYNC_MSG_NOT_FOUND",
                        "A Synopsys SMBus message was not followed by the sync message. This should be marked as recovered mail message bitmap info [mail_message : bit no (left to right)] END_OF_INITILIAZATION : 0 END_OF_FINE_WRITE_LEVELING : 1 END_OF_READ_ENABLE_TRAINING : 2 END_OF_RD_DLY_CNTR_OPT : 3 END_OF_WR_DLY_CNTR_OPT : 4 END_OF_2D_RD_DLY_V_CNTR_OPT : 5 END_OF_2D_WR_DLY_V_CNTR_OPT : 6 END_OF_MAX_RD_LAT_TRAINING : 7 END_OF_RD_DQ_DSKEW_TRAINING : 8 TRAINING_STAGE_RESERVED : 9 END_OF_CS_CA_TRAINING : 10 END_OF_RCD_QCS_QCA_TRAINING : 11 END_OF_LRDIMM_MREP_TRAINING : 12 END_OF_LRDIMM_DWL_TRAINING : 13 END_OF_LRDIMM_MRD_TRAINING : 14 END_OF_LRDIMM_MWD_TRAINING : 15 GEN_WRT_NOISE_SYN : 16 END_OF_MPR_RD_DLY_CNTR_OPT : 17 END_OF_WR_LVL_COARSE_DLY : 18 UNKNOWN_MAJOR_MESSAGE : 19 SUCCESSFUL_COMPLETION : 20 FAILED_COMPLETION : 21" ],
            0x025f3a: [ "RC_ODY_DRAMINIT_TRAINING_FAILURE_MAIL",
                        "Ody draminit training mailbox message indicated a training failure. mail message bitmap info [mail_message : bit no (left to right)] END_OF_INITILIAZATION : 0 END_OF_FINE_WRITE_LEVELING : 1 END_OF_READ_ENABLE_TRAINING : 2 END_OF_RD_DLY_CNTR_OPT : 3 END_OF_WR_DLY_CNTR_OPT : 4 END_OF_2D_RD_DLY_V_CNTR_OPT : 5 END_OF_2D_WR_DLY_V_CNTR_OPT : 6 END_OF_MAX_RD_LAT_TRAINING : 7 END_OF_RD_DQ_DSKEW_TRAINING : 8 TRAINING_STAGE_RESERVED : 9 END_OF_CS_CA_TRAINING : 10 END_OF_RCD_QCS_QCA_TRAINING : 11 END_OF_LRDIMM_MREP_TRAINING : 12 END_OF_LRDIMM_DWL_TRAINING : 13 END_OF_LRDIMM_MRD_TRAINING : 14 END_OF_LRDIMM_MWD_TRAINING : 15 GEN_WRT_NOISE_SYN : 16 END_OF_MPR_RD_DLY_CNTR_OPT : 17 END_OF_WR_LVL_COARSE_DLY : 18 UNKNOWN_MAJOR_MESSAGE : 19 SUCCESSFUL_COMPLETION : 20 FAILED_COMPLETION : 21" ],
            ...
            0x037d5c: [ "RC_POZ_I2C_STATUS_INTR_ERROR",
            ...
            0x040d14: [ "RC_ODY_ECS_FAIL",
                        "Odyssey ECS test had at least one DRAM beyond the error threshold" ],
            ...
            0x048cba: [ "RC_POZ_ARBSEMA_RELEASE_ERROR",
                        "Couldn't release semaphore on a side" ],
            ...
            0x05f1a8: [ "RC_SBE_SPI_LENGTH_IS_NOT_ALIGNED",
                        "Procedure: Error calling poz_sbe_spi_cmd HWP Error due to the given length is not aligned." ],
            ...
            0x070295: [ "RC_PIBMEM_ECC_ERR",
                        "Uncorrectable error occurred while PIB memory access" ],
            0x075e16: [ "RC_POZ_CHIPLET_NOT_FOUND",
                        "Provided chiplet number does not match anything in provided target" ],
            0x07694c: [ "RC_INVALID_SIZE_FOR_ENDIANNESS_CORRECTION",
                        "The endianness correction cannot be handled for this element size." ],
            0x077a17: [ "RC_TEST_CALLOUT_DIMM_TARGET0",
                        "Test sbe ffdc with bad target dimm callout with target instance 0" ],
            ...
            0x084533: [ "RC_TEST_CALLOUT_MEMPORT_GARD_TARGET0",
                        "Test sbe ffdc with bad target memport with gard with target instance 0" ],
            ...
            0x0a30b5: [ "RC_POZ_SCRATCH_ALLOC_FAILED",
                        "Scratch allocation returned NULL pointer" ],
            0x0a5760: [ "RC_SBE_SPI_WRITTEN_DATA_MISMATCH",
                        "Procedure: Error calling poz_sbe_spi_cmd HWP Error due to the verification of data after writing to flash failed." ],
            ...
            0x0ac887: [ "RC_TEST_CALLOUT_OCMB_DECONFIGURE_GARD_TARGET0",
                        "Test sbe ffdc with target chip and target pervasive deconfigure and gard ocmb target with instance 0" ],
            ...
            0x0ba7b2: [ "RC_SPI_TPM_RESPONSE_TOO_LONG",
                        "The response returned by the TPM does not fit the receive buffer" ],
            0x0bb409: [ "RC_IO_PPE_UNDEGRADE_FAIL",
                        "IO PPE undegrade attempt failed" ],
            0x0bfea1: [ "RC_MSS_DDR5_MR38_ODTLON_NT_ATTR_VALUE",
                        "A bad ODTLon NT (non terminating) value was passed to MR38" ],
            0x0c0af0: [ "RC_TEST_DIMM_TARGET0",
                        "Test sbe ffdc with bad target dimm with target instance 0." ],
            ...
            0x0c5b94: [ "RC_SPI_TPM_FIFO_TIMEOUT",
                        "Timed out while waiting for the TPM FIFO to have space/data available" ],
            ...
            0x0e06d6: [ "RC_RCS_CLOCK_TEST_OUT_ERROR",
            ...
            0x0e608c: [ "RC_POZ_PPM_ERROR",
                        "The redundant clock switch detected a problem with the PPM Watchdog. The root cause may be the processor or the incoming clock(s)." ],
            ...
            0x0e8ad6: [ "RC_SPI_FLASH_ERASE_FAIL",
                        "A flash sector erase operation failed" ],
            ...
            0x0ef06c: [ "RC_TEST_CALLOUT_MEMPORT_DECONFIGURE_GARD_TARGET1",
                        "Test sbe ffdc with bad target memport with deconfigure and gard with target instance 1" ],
            ...
            0x0fb5a8: [ "RC_ODY_INVALID_ATX_OVERRIDE",
                        "Invalid attribute value recieved in phyinit CSR override. Failing attribute will be identified in error trace or ffdc." ],
            ...
            0x105d1f: [ "RC_ODY_PHYINIT_INVALID_EN_TX_DQ_PREAMBLE_PATTERN_U0",
                        "Ody phyinit invalid EnTxDqPreamblePatternU0." ],
            ...
            0x11fbcb: [ "RC_SCAN_CHIPLET_NOT_FUNCTIONAL",
                        "Attempted to create a single chiplet target for scanning but the requested chiplet is not functional" ],
            0x12270a: [ "RC_PM_MALF_NO_DEAD_CORES",
                        "PM malfunction detected but it did not cause loss of functional cores." ],
            0x122738: [ "RC_NO_PMIC_DT_DDR5_TARGETS_FOUND",
                        "No PMIC DT Targets were found when running the health check tool" ],
            0x1228b5: [ "RC_ODY_DRAMINIT_PERDRAM_RECOVERY_ATTEMPTS_EXCEEDED",
                        "Ody draminit's per DRAM recovery algorithm exceeded recovery attempts." ],
            ...
            0x146e16: [ "RC_ODY_START_ADDR_BIGGER_THAN_END_ADDR",
                        "A starting address larger than an ending address was passed into multi-port init" ],
            0x1474ff: [ "RC_P10_BOOT_MODE_BITVEC_PLAT_ERROR",
                        "Platform requested bit position is out of range for HW image capabilities" ],
            0x14764a: [ "RC_ODY_TOO_MANY_RANKS_FOR_SUBTEST_SUPPORT",
                        "DIMM contains too many mranks/sranks to use an MCBIST subtest per port/rank. Max number of subtest start/end address pairs is four, so a DIMM can have a maximum of four mrank/sranks per port." ],
            ...
            0x15c044: [ "RC_POZ_CFAM_FAILURE",
                        "SBE encountered an unsupperted CFAM access" ],
            ...
            0x16140d: [ "RC_UNEXPECTED_ATTR_CHIP_TYPE",
                        "The attribute data chip type does not match the chip type passed to the procedure." ],
            0x16320c: [ "RC_SPI_TPM_REQUEST_TOO_LONG",
                        "The TPM indicated it was no longer expecting data before the full request got sent" ],
            ...
            0x17f95c: [ "RC_POZ_CBS_ACK_NOT_SEEN_ERR",
                        "CBS_ACK did not reach expected value within poll time" ],
            ...
            0x189810: [ "RC_SPI_FLASH_ERASE_INSUFFICIENT",
                        "Code should have erased far enough for new data to be written but didn't" ],
            ...
            0x18c2cc: [ "RC_GETTRACEARRAY_INVALID_TARGET",
            ...
            0x1a0018: [ "RC_MSS_DDR5_MR33_DQS_RTT_PARK_PER_DRAM_FIELD_VALUE",
            ...
            0x1a94e6: [ "RC_BAD_BIST_PARAMS_FORMAT",
                        "bist_params does not have correct format" ],
            ...
            0x1c285e: [ "RC_CORE_MULTICAST_SCAN_INVALID_ARGS",
                        "Core multicast scan attempted with empty core selection or on regions that don't support parallel scan" ],
            ...
            0x1c7a88: [ "RC_TEST_TEMPSENSOR_TARGET0",
                        "Test sbe ffdc with target temp sensor with instance 0" ],
            ...
            0x1d1da5: [ "RC_TEST_CALLOUT_MEMPORT_DECONFIGURE_TARGET0",
                        "Test sbe ffdc with bad target port with deconfigure with target instance 0" ],
            0x1d2f20: [ "RC_IO_PPE_DONE_DCCAL_FAILED",
            ...
            0x1e1b37: [ "RC_ODY_GETTRACEARRAY_INVALID_ARRAY",
                        "The specified trace array ID is invalid." ],
            0x1e3ceb: [ "RC_ODY_NUM_MRANKS_OUT_OF_BOUNDS",
                        "Number of mranks reported a zero during row repair operation" ],
            ...
            0x1f18d3: [ "RC_ODY_OUT_OF_BOUNDS_DBYTE_PASSED_TO_SWIZZLE",
                        "Bad dbyte index passed to swizzle function" ],
            0x1f9e5b: [ "RC_POZ_ARBSEMA_RESERVE_TIMEOUT",
                        "Couldn't reserve semaphore on a side" ],
            ...
            0x22641e: [ "RC_POZ_PIB_OFFLINE_ERROR",
            ...
            0x23def1: [ "RC_MSS_DDR5_MR33_CA_ODT_PER_DRAM_ATTR_VALUE",
            ...
            0x248989: [ "RC_MSS_DDR5_MR32_CA_ODT_PER_DRAM_FIELD_VALUE",
            ...
            0x2565e1: [ "RC_PM_ELOG_ENTRY_NOT_FOUND",
                        "Entry not found in error log table." ],
            ...
            0x26374b: [ "RC_MSS_DDR5_MR32_CA_ODT_PER_DRAM_ATTR_VALUE",
                        "A bad CK or CS ODT was passed to MR32" ],
            0x26ab29: [ "RC_ODY_PHYINIT_INVALID_EN_TX_DQ_PREAMBLE_PATTERN_U1",
                        "Ody phyinit invalid EnTxDqPreamblePatternU1." ],
            0x26b80a: [ "RC_ODY_ECS_CCS_STUCK_IN_PROGRESS",
                        "Trying to run ECS when CCS engine is in use and is not available" ],
            0x26fba6: [ "RC_MSS_MCBIST_STUCK_IN_PROGRESS",
                        "MCBIST engine is in use and is not available" ],
            ...
            0x27d054: [ "RC_SBE_SPI_ADDRESS_IS_NOT_ALIGNED",
                        "Procedure: Error calling poz_sbe_spi_cmd HWP Error due to the given address is not aligned." ],
            ...
            0x29db8b: [ "RC_TEST_CALLOUT_OCMB_DECONFIGURE_GARD_TARGET1",
                        "Test sbe ffdc with target chip and target pervasive deconfigure and gard ocmb target with instance 1" ],
            0x2a0456: [ "RC_POZ_SBEFIFO_OPERATION_FAILED",
                        "SBE FIFO operation failed" ],
            0x2a1f11: [ "RC_SPI_FLASH_ERASE_BUFFER_NEEDED",
                        "The requested write operation needs an erase buffer to save partial erase block data but no buffer was provided at driver initialization." ],
            ...
            0x2a6c3c: [ "RC_GETTRACEARRAY_CORE_NOT_DUMPABLE",
            ...
            0x2b634e: [ "RC_SPI_MEMORY_INVALID_WRITE_SEQUENCE",
                        "A write operation was not properly called in the begin-data[-data...]-end sequence" ],
            ...
            0x2c3641: [ "RC_MSS_MAINT_BAD_RANK_INPUT",
            ...
            0x2c72cd: [ "RC_POZ_RCS_ERROR",
                        "The redundant clock switch detected a problem. The root cause may be the processor or the incoming clock(s)." ],
            0x2c769a: [ "RC_SPI_FLASH_WRITE_PROTECTED",
            ...
            0x2ef289: [ "RC_TEST_CALLOUT_MEMPORT_TARGET0",
                        "Test sbe ffdc with bad target port callout with target instance 0" ],
            ...
            0x2fcdcd: [ "RC_TEST_CALLOUT_MEMPORT_GARD_TARGET1",
                        "Test sbe ffdc with bad target memport with gard with target instance 1" ],
            ...
            0x348f99: [ "RC_SPI_TPM_READY_TIMEOUT",
                        "Timed out while waiting for the TPM to become ready to accept commands" ],
            ...
            0x35197e: [ "RC_MSS_MAINT_SYMBOL_NOT_FOUND",
            ...
            0x3545fd: [ "RC_POZ_I2CC_RESET_ERROR",
                        "Error resetting Odyssey I2C controller" ],
            ...
            0x35d6e0: [ "RC_SPI_TPM_RESPONSE_TOO_SHORT",
                        "The response returned by the TPM is too short to contain a length field" ],
            0x360f36: [ "RC_P10_RAM_NOT_SETUP_OPCODE_ERR",
                        "RAM is not setup as active before doing opcode operation" ],
            0x36a24e: [ "RC_ODY_DRAMINIT_NOT_CLEAN",
                        "Ody draminit run was not clean. This assert is caused by a bad training run and ATTR_ODY_DRAMINIT_ERROR_ON_FAILURE. [mail_message : bit no (left to right)] END_OF_INITILIAZATION : 0 END_OF_FINE_WRITE_LEVELING : 1 END_OF_READ_ENABLE_TRAINING : 2 END_OF_RD_DLY_CNTR_OPT : 3 END_OF_WR_DLY_CNTR_OPT : 4 END_OF_2D_RD_DLY_V_CNTR_OPT : 5 END_OF_2D_WR_DLY_V_CNTR_OPT : 6 END_OF_MAX_RD_LAT_TRAINING : 7 END_OF_RD_DQ_DSKEW_TRAINING : 8 TRAINING_STAGE_RESERVED : 9 END_OF_CS_CA_TRAINING : 10 END_OF_RCD_QCS_QCA_TRAINING : 11 END_OF_LRDIMM_MREP_TRAINING : 12 END_OF_LRDIMM_DWL_TRAINING : 13 END_OF_LRDIMM_MRD_TRAINING : 14 END_OF_LRDIMM_MWD_TRAINING : 15 GEN_WRT_NOISE_SYN : 16 END_OF_MPR_RD_DLY_CNTR_OPT : 17 END_OF_WR_LVL_COARSE_DLY : 18 UNKNOWN_MAJOR_MESSAGE : 19 SUCCESSFUL_COMPLETION : 20 FAILED_COMPLETION : 21" ],
            ...
            0x370b00: [ "RC_SPI_MEMORY_ADDRESS_OVERRUN",
                        "Invalid address/length: The request exceeds the size of the memory device" ],
            ...
            0x38f9cc: [ "RC_P10_MSS_NO_SUPPORTED_FREQ",
                        "When considering the frequencies in the MRW and the max supported frequencies based on DIMM config, there are no applicable frequencies remaining. User data PORTX_FREQ_SUPPORT is a bitmap of DDR frequencies supported by each memory port due to MRW and SPD constraints, with bit0=2666 bit1=2933 bit2=3200 MT/s bit3=4000 MT/s bit4=4800 MT/s" ],
            0x390ace: [ "RC_INSUFFICIENT_DATA_IN_BUFFER",
                        "The buffer does not have enough data to process further." ],
            0x397455: [ "RC_ODY_DRAMINIT_REPAIRS_EXCEEDED",
                        "Ody draminit's recovery algorithm exceeded available repairs." ],
            ...
            0x3ac6c1: [ "RC_TEST_CALLOUT_MEMPORT_DECONFIGURE_TARGET1",
                        "Test sbe ffdc with bad target port with deconfigure with target instance 1" ],
            ...
            0x3c19a7: [ "RC_PMIC_ENABLE_FAIL_DDR5_4U",
            ...
            0x3e4b0a: [ "RC_SBE_BOOT_CHECK_ERR_CFAM_PATH",
                        "SBE did not Boot prior to timeout in CFAM Path" ],
            ...
            0x4040bd: [ "RC_SPI_TPM_ACCESS_TIMEOUT",
                        "Timed out while waiting for locality access to be granted" ],
            ...
            0x434d61: [ "RC_POZ_I2C_FIFO_TIMEOUT_ERROR",
                        "I2C fifo condition error - timedout waiting for a condition" ],
            0x436b44: [ "RC_SPI_RSC_ERR",
            ...
            0x43e295: [ "RC_PMIC_ENABLE_FAIL_DDR5_2U",
                        "A DDR5 2U PMIC had errors during pmic_enable. See previous recoverable errors to further diagnose. Note: this return code is used for OCMB without PMIC redundancy" ],
            ...
            0x45b2c1: [ "RC_ODY_DRAMINIT_FIR_FOUND",
                        "Ody draminit found a FIR. Custom assert so the caller can handle it" ],
            ...
            0x46ecae: [ "RC_MIXED_TP_CHIPLET_BIST_REQUESTED",
                        "Attempted BIST with TP and non-TP chiplet(s)" ],
            ...
            0x48235f: [ "RC_TEST_CALLOUT_TEMPSENSOR_TARGET0",
                        "Test sbe ffdc with target temp sensor and callouts with target instance 0" ],
            ...
            0x49ef51: [ "RC_MSS_MAINT_INVALID_SYMBOL",
            ...
            0x4c69e3: [ "RC_POZ_SRAM_ABIST_DONE_BIT_ERR",
            ...
            0x4cbdc2: [ "RC_PROGRAM_INTERRUPT",
                        "Program interrupt promoted" ],
            0x4cccd5: [ "RC_TEST_CALLOUT_DIMM_DECONFIG_TARGET2",
                        "Test sbe ffdc with bad target dimm with deconfig with target instance 2" ],
            ...
            0x4e95a7: [ "RC_MSS_ODY_CCS_INCONSISTENT_RANK",
                        "Odyssey CCS requires all reads and writes in a program to target the same rank. The given program contains read or write commands to multiple ranks." ],
            0x4eae57: [ "RC_MSS_VOLT_DDR4_TYPE_REQUIRED_VOLTAGE",
                        "One or more DIMMs do not support required voltage for DDR4." ],
            0x4eaef5: [ "RC_POZ_TP_STOPCLOCKS_ERR",
                        "Error occured while stopping clocks for all regions of TP except SBE" ],
            0x4f13c5: [ "RC_SPI_TPM_COMMAND_TIMEOUT",
                        "Timed out while waiting for the TPM to complete a command" ],
            ...
            0x4fa2d8: [ "RC_SBE_FILE_NOT_FOUND",
                        "SBE PLAT Error - File not found" ],
            0x4fa496: [ "RC_GETTRACEARRAY_INVALID_BUS",
                        "The specified trace bus ID is invalid." ],
            ...
            0x4fe62e: [ "RC_PUTRING_CHECKWORD_DATA_MISMATCH",
            ...
            0x502dae: [ "RC_EXTRACT_SBE_RC_TPM_ERR",
                        "TPM fail occurred Action: first time do a re IPL, second time do a TPM callout [REIPL_FIRST_THEN_TPM_CALLOUT]" ],
            ...
            0x5153e2: [ "RC_POZ_RCS_FPLL_NOT_LOCKED",
                        "The redundant clock switch Filter PLLs are not locking. The root cause may be the processor or the incoming clock(s)." ],
            ...
            0x518577: [ "RC_POZ_PIB_TIMEOUT_ERROR",
                        "SBE SCOM failure - Timeout error" ],
            0x51993b: [ "RC_SPPE_RUNNING",
            ...
            0x51e14e: [ "RC_MSS_CCS_STUCK_IN_PROGRESS",
                        "CCS engine is in use and is not available" ],
            0x51eb59: [ "RC_TEST_CALLOUT_DIMM_DECONFIG_GARD_TARGET0",
                        "Test sbe ffdc with bad target dimm with deconfig and gard with target instance 0" ],
            0x51f7c0: [ "RC_POZ_PIB_XSCOM_ERROR",
            ...
            0x5303e7: [ "RC_MSS_EXP_CCS_UE_SUE",
                        "CCS reports a UE or SUE in the CCS program array Chould be an indicator of corruption in the CCS program" ],
            0x5334fe: [ "RC_BAD_ELOG_BUFFER",
                        "Buffer Passed by HB to copy hcode elog is invalid or corrupt." ],
            ...
            0x53bd6a: [ "RC_POZ_PAK_OPERATION_FAILED",
                        "SBE PLAT Error - Pak operation failed" ],
            ...
            0x57fdc4: [ "RC_ODY_ECS_MR20_PAT0",
                        "Collect MR20 data from ECS test fail for pattern0" ],
            0x5820e8: [ "RC_P10_TOD_SETUP_NULL_NODE",
                        "Procedure: p10_tod_setup A null node has been passed into the procedure" ],
            0x585377: [ "RC_POZ_VDN_POWER_NOT_ON",
                        "Nest power VDN is not on.(VDD_NEST_OBSERVE not set)" ],
            ...
            0x5a38e4: [ "RC_MSS_INVALID_DDR5_DRAM_WR_PREAMBLE",
                        "An invalid value was detected in ATTR_DDR5_DRAM_WR_PREAMBLE" ],
            0x5a74ad: [ "RC_POZ_TP_VITL_CLK_OFF_ERR",
            ...
            0x5ed664: [ "RC_PM_ELOG_INVALID_INPUT",
                        "Invalid inputs passed to list error logs." ],
            0x5f0acb: [ "RC_SBE_FILE_HASH_MISMATCH",
                        "SBE PLAT Error - File hash mismatch" ],
            0x5f2adc: [ "RC_TEST_CALLOUT_DIMM_GARD_TARGET0",
                        "Test sbe ffdc with bad target dimm with gard with target instance 0" ],
            ...
            0x621660: [ "RC_TEST_CALLOUT_PERV_DECONFIGURE_TARGET8",
                        "Test sbe ffdc with bad target with deconfigure with target instance 8" ],
            0x6244d8: [ "RC_POZ_IMMEDIATE_CLOCKSTOP_ON_XSTOP",
                        "Immediate clock stop on xstop" ],
            0x625630: [ "RC_MSS_MDS_I2C_WRONG_RSP_SIZE",
                        "Received an incorrect response size for MDS I2C scoms." ],
            0x62b2c9: [ "RC_POZ_CPLT_NOT_ALIGNED_ERR",
                        "Chiplet not aligned" ],
            0x62edaf: [ "RC_POZ_PIB_ADDRESS_ERROR",
            ...
            0x653402: [ "RC_TEST_CALLOUT_DIMM_GARD_TARGET2",
                        "Test sbe ffdc with bad target dimm with gard with target instance 2" ],
            ...
            0x662776: [ "RC_MSS_FREQ_INVALID_SIZE_ENCODE",
                        "MSS frequency limiting algorithm was unable to encode a provided DIMM size" ],
            ...
            0x6669a5: [ "RC_INVALID_DT_INDEX_RECEIVED",
                        "Out of bounds DT index encountered in pmic_enable target loop. Expected max 4 DTs." ],
            0x66847b: [ "RC_EXTRACT_SBE_RC_DATA_STORE_INTR",
                        "Data storage interrupt Action:Retrigger IPL or HRESET [RESTART_SBE]" ],
            0x66c7f8: [ "RC_ODY_SCRATCH_REGS_UTILS_BUCKET_LOOKUP_ERR",
                        "Unable to match desired Odyssey freqeuncy with supported PLL bucket setting" ],
            ...
            0x67f998: [ "RC_POZ_INVALID_GROUP_ID",
                        "Invalid group id passed to module multicast setup" ],
            ...
            0x683b7a: [ "RC_SPI_POLL_TIMEOUT",
                        "Polling for a status change timed out" ],
            ...
            0x686a87: [ "RC_TEST_CALLOUT_MEMPORT_DECONFIGURE_GARD_TARGET0",
                        "Test sbe ffdc with bad target memport with deconfigure and gard with target instance 0" ],
            ...
            0x692215: [ "RC_TEST_CALLOUT_MEMPORT_TARGET1",
                        "Test sbe ffdc with bad target port callout with target instance 1" ],
            ...
            0x6a2742: [ "RC_BIST_NONZERO_MISCOMPARES",
                        "At least one chiplet failed compare check in BIST" ],
            0x6a5efe: [ "RC_MSS_MAINT_DO_STEER_ALL_SPARES_DEPLOYED",
            ...
            0x6bdb86: [ "RC_POZ_PIB_CLOCK_ERROR",
            ...
            0x6c805d: [ "RC_INVALID_PMIC_GI2C_TARGET_CONFIG",
                        "Expected 4 GENERICI2CRESPONDER targets and at least 2 PMICs in order to properly perform 4U pmic_enable." ],
            0x6ca9fb: [ "RC_MSS_INVALID_VPD_KEYWORD_MAX",
                        "VPD keyword is too big for space allocated for it." ],
            0x6cf346: [ "RC_MISSING_PORT_INFO_DRAMINIT",
                        "No memory port info supplied by DRAM init while calling ody_blame_firs" ],
            0x6cf942: [ "RC_SBE_SPI_OPR_COMPLETION_CHECK_ERROR",
                        "Procedure: Error calling poz_sbe_spi_cmd HWP Error due to SPI operation failed to complete." ],
            ...
            0x6e15b4: [ "RC_NONZERO_MISCOMPARES",
                        "At least one ring failed compare check" ],
            ...
            0x6f20ee: [ "RC_SPI_TPM_RESPONSE_BUF_TOO_SHORT",
                        "The response buffer for a TPM transaction is too small to fit the response length" ],
            0x6f8938: [ "RC_MSS_DDR5_MR32_CA_ODT_ATTR_VALUE",
                        "A bad CK or CS ODT was passed to MR32" ],
            0x6f95d5: [ "RC_BAD_HOMER_PTR",
                        "Pointer to HOMER base is bad" ],
            0x6fa559: [ "RC_MSS_ODY_DQS_DRIFT_TRACK_NO_HALF_DIMM",
                        "Odyssey automatic DQS drift track function does not support XMETA mode." ],
            ...
            0x70214c: [ "RC_PMIC_NOT_DDR5_REVISION",
                        "The PMIC revision value did not match TI REV 23 or greater. Exiting to avoid applying DDR5 only procedures." ],
            ...
            0x72b17c: [ "RC_MSS_RESTORE_REPAIRS_BYTE_OUT_OF_RANGE",
                        "The byte index to perform repairs on / deploy a spare was out of range." ],
            ...
            0x73d989: [ "RC_SPI_FLASH_WRITE_FAIL",
                        "A flash page write operation failed" ],
            0x740bd9: [ "RC_SPI_FLASH_UNKNOWN_DEVICE",
                        "The type of an attached Flash device could not be determined" ],
            ...
            0x74e171: [ "RC_TEST_CALLOUT_TEMPSENSOR_TARGET1",
                        "Test sbe ffdc with target temp sensor and callouts with target instance 1" ],
            ...
            0x75b9e8: [ "RC_SBE_SPI_INVALID_LENGTH",
                        "Procedure: Error calling poz_sbe_spi_cmd HWP Error due to the given length is not in the required range." ],
            ...
            0x77e7ec: [ "RC_DIMM_RUNNING_IN_N_MODE_DDR5",
            ...
            0x78b1a9: [ "RC_TEST_TEMPSENSOR_TARGET1",
                        "Test sbe ffdc with target temp sensor with instance 1" ],
            ...
            0x7a067d: [ "RC_ODY_DRAMINIT_PERDRAM_REPAIRS_EXCEEDED",
                        "Ody per DRAM draminit's recovery algorithm exceeded available repairs." ],
            ...
            0x7ce163: [ "RC_IO_PPE_DONE_CLEANUP_FAILED",
                        "IO PPE done BIST clenaup failed" ],
            ...
            0x7d41d4: [ "RC_TEST_CALLOUT_DIMM_TARGET2",
                        "Test sbe ffdc with bad target dimm callout with target instance 2" ],
            0x7d7158: [ "RC_SPI_INVALID_TRANSACTION_PARMS",
                        "An attempt to initiate a SPI transaction used invalid parameters" ],
            ...
            0x7e2a65: [ "RC_SPI_MEMORY_WRITE_TIMEOUT",
                        "A write/erase command to SPI memory did not complete in time" ],
            ...
            0x7f588b: [ "RC_ODY_GETTRACEARRAY_TRACE_RUNNING",
                        "An attempt was made to dump a trace array while it was still running." ],
            0x7f8fa1: [ "RC_THOLD_ERR",
                        "thold status not matching the expected value 	in clock start stop sequence" ],
            0x800f95: [ "RC_PM_OCB3_PUT_DATA_ERROR",
                        "Indicates that a fail occured writing the OCB data register as part of a channel PUT operation. Such a fail can occur due to channel setup or use issues (i.e.overflow) or secondary failures to a SCOM access (eg address issue going to the OCC SRAM)." ],
            0x80129f: [ "RC_BAD_ELOG_BUFFER_LENGTH",
                        "Buffer Passed by HB is not big enough to copy hcode elog." ],
            ...
            0x80e6f1: [ "RC_ODY_ECS_MR16_TO_19_PAT0",
                        "Collect MR16:19 data from ECS test fail for pattern0" ],
            ...
            0x8237e7: [ "RC_PMIC_DROPPED_INTO_N_MODE_DDR5",
                        "The provided PMIC_ID on OCMB_TARGET had errors which has caused a drop into N-Mode. Should be logged as recoverable, only a bad status resulting from multiple PMICs would cause a procedure failure via a different error." ],
            0x82b844: [ "RC_ODY_OUT_OF_BOUNDS_RANK_PASSED_TO_SWIZZLE",
                        "Bad rank index passed to swizzle function" ],
            ...
            0x843b3b: [ "RC_ODY_ECS_MR20_PAT1",
                        "Collect MR20 data from ECS test fail for pattern1" ],
            ...
            0x859a7e: [ "RC_UNEXPECTED_ATTR_FILE_TYPE",
                        "The attribute data file type does not match the file type of the parser." ],
            ...
            0x8698e7: [ "RC_SYSTEM_PAU_FREQ_MISMATCH",
                        "The PAU frequency for this part does not match the values in across nodes in the system.This indicates the parts from different sorts may be plugged into the machine." ],
            ...
            0x87c405: [ "RC_POZ_PLL_LOCK_ERROR",
                        "Chiplet PLL lock error" ],
            ...
            0x882db3: [ "RC_ODY_SPPE_ATTR_SETUP_INVALID_TARGET",
            ...
            0x898aba: [ "RC_TEST_PERV_TARGET8",
                        "Test sbe ffdc with bad target perv with instance 8" ],
            0x89c01b: [ "RC_IO_PPE_RESET",
                        "PPE failed to reset" ],
            ...
            0x8c1a76: [ "RC_ODY_DRAMINIT_TRAINING_FAILURE_MSG_BLOCK",
                        "Ody draminit training message block indicated a training failure. mail message bitmap info [mail_message : bit no (left to right)] END_OF_INITILIAZATION : 0 END_OF_FINE_WRITE_LEVELING : 1 END_OF_READ_ENABLE_TRAINING : 2 END_OF_RD_DLY_CNTR_OPT : 3 END_OF_WR_DLY_CNTR_OPT : 4 END_OF_2D_RD_DLY_V_CNTR_OPT : 5 END_OF_2D_WR_DLY_V_CNTR_OPT : 6 END_OF_MAX_RD_LAT_TRAINING : 7 END_OF_RD_DQ_DSKEW_TRAINING : 8 TRAINING_STAGE_RESERVED : 9 END_OF_CS_CA_TRAINING : 10 END_OF_RCD_QCS_QCA_TRAINING : 11 END_OF_LRDIMM_MREP_TRAINING : 12 END_OF_LRDIMM_DWL_TRAINING : 13 END_OF_LRDIMM_MRD_TRAINING : 14 END_OF_LRDIMM_MWD_TRAINING : 15 GEN_WRT_NOISE_SYN : 16 END_OF_MPR_RD_DLY_CNTR_OPT : 17 END_OF_WR_LVL_COARSE_DLY : 18 UNKNOWN_MAJOR_MESSAGE : 19 SUCCESSFUL_COMPLETION : 20 FAILED_COMPLETION : 21" ],
            ...
            0x8c993e: [ "RC_SPI_MEMORY_INCOMPLETE_WRITE",
                        "A write operation did not write the intended amount of data" ],
            ...
            0x8dc0d4: [ "RC_POZ_PIB_PARITY_ERROR",
            ...
            0x8ea373: [ "RC_PARALLEL_SCAN_COMPARE_ERR",
                        "Putring failed to complete parallel scanning" ],
            ...
            0x909cef: [ "RC_MSS_ODY_DQS_DRIFT_TRACK_UNABLE_TO_QUIESCE_BUS",
                        "Odyssey manual DQS drift track chip-op was unable to detect bus quiesce state after the threshold number of attempts." ],
            ...
            0x90c07f: [ "RC_PUTRING_OPCG_DONE_TIMEOUT",
            ...
            0x93d730: [ "RC_POZ_FILE_HASH_MISMATCH",
                        "SBE PLAT Error - File hash mismatch" ],
            ...
            0x94723a: [ "RC_MSS_ODY_CCS_XMETA_BOTH_HALVES_SELECTED",
                        "Odyssey CCS requires only one half selected in MODEQ for XMETA mode." ],
            0x947831: [ "RC_SPI_ERROR_STATUS",
                        "The SPI controller logic signaled an error" ],
            0x9482de: [ "RC_SPI_MEMORY_INVALID_ADDR_LEN",
                        "Invalid address/length: Must be divisible by 8 in ECC mode" ],
            0x948af1: [ "RC_XIPC_MVPD_MK_KEYWORD_VERSION_ERROR",
                        "The MK Keyword version from MVPD, found to be invalid" ],
            0x94b60d: [ "RC_UNSUPPORTED_ATTR_LEVEL",
                        "Indicates that an attribute level of SPPE/Host is incompatible with the other. This RC will likely trigger SPPE code update." ],
            0x94f8fe: [ "RC_PM_BACKING_CACHEPOWER_DOWN_ECO_ERR",
                        "Backing cache unexpectedly configured in ECO mode" ],
            0x9523fd: [ "RC_INVALID_ATTR_FILE",
                        "Generic attribute file format error" ],
            ...
            0x963c10: [ "RC_SPI_MEMORY_VERIFY_FAIL",
                        "The data read back from memory after a write operation did not match the write data" ],
            ...
            0x9889d1: [ "RC_ODY_INVALID_GI2C_TARGET_CONFIG",
                        "RCD target not found. RCD should be at GI2C Target position 1" ],
            ...
            0x99b405: [ "RC_ODY_DRAMINIT_SWIZZLE_INVALID_DBYTE",
                        "DRAMINIT swizzle detect recovery found an invalid dbyte" ],
            0x9a2c89: [ "RC_POZ_PIB_PARTIAL_ERROR",
                        "SBE SCOM failure - Partial SCOM failure" ],
            0x9a517b: [ "RC_TEST_MEMPORT_TARGET1",
                        "Test sbe ffdc with bad target port with target instance 1" ],
            ...
            0x9dc57f: [ "RC_P10_OMI_SETUP_BARS_INVALID_BAR_1",
                        "ATTR_OMI_INBAND_BAR_BASE_ADDR_OFFSET had an invalid value" ],
            0x9dd9d2: [ "RC_POZ_I2C_WAIT_FOR_CMD_COMP_TIMEOUT_ERROR",
                        "I2C wait for command completion error - Timeout error" ],
            ...
            0xa0a2b5: [ "RC_ODY_DRAMINIT_TOTAL_RECOVERY_ATTEMPTS_EXCEEDED",
                        "Ody draminit's recovery algorithm exceeded the total number of recovery attempts." ],
            ...
            0xa22636: [ "RC_MSS_PORT_SUPPORTS_NO_FREQUENCIES",
                        "The VPD on this memory port (EFD blocks in DDIMM SPD) does not indicate support for any system-supported memory frequencies. This error could also be caused by problems reading the SPD." ],
            ...
            0xa2e476: [ "RC_ODY_DRAMINIT_MSGBLOCK",
                        "Collect the Ody draminit message block for logging" ],
            0xa2eb3f: [ "RC_TEST_MEMPORT_TARGET0",
                        "Test sbe ffdc with bad target port with target instance 0" ],
            ...
            0xa47853: [ "RC_TEST_CALLOUT_DIMM_DECONFIG_GARD_TARGET2",
                        "Test sbe ffdc with bad target dimm with deconfig and gard with target instance 2" ],
            ...
            0xa4d070: [ "RC_ODY_SPPE_ATTR_SETUP_GRID_FREQ_MISMATCH",
                        "Grid frequency posted in scratch register by cmdtable execution does not match value expected based on PLL bucket request" ],
            ...
            0xa5ba9b: [ "RC_POZ_FILE_NOT_FOUND",
                        "SBE PLAT Error - File not found" ],
            0xa614cd: [ "RC_GETTRACEARRAY_TRACE_RUNNING",
                        "An attempt was made to dump a trace array while it was still running." ],
            0xa61512: [ "RC_IO_PPE_TX_TDR_FAILED",
                        "Tx TDR Failure" ],
            0xa6a85e: [ "RC_ROTATE_OP_FAILED",
                        "Rotate operation timed out during scanning" ],
            0xa6d0ed: [ "RC_ODY_ECS_ERR_THRESHOLD_EXCEEDED",
                        "More errors are found in the memory than the threshold value" ],
            ...
            0xa72c4d: [ "RC_POZ_STREAM_GET_FAILED",
                        "SBE stream get failed" ],
            0xa72f92: [ "RC_MSS_INCORRECT_SUBTEST_TYPE",
                        "An invalid subtest type is encountered while resuming the scrub/steer test after enabling DQS drift tracking" ],
            ...
            0xa8164e: [ "RC_POZ_SBE_STOPCLOCKS_ERR",
            ...
            0xa83472: [ "RC_ODY_ROW_REPAIR_ENTRY_OUT_OF_BOUNDS",
                        "Input supplied to row repair function out of bounds." ],
            ...
            0xa9243c: [ "RC_TEST_CALLOUT_PERV_TARGET8",
                        "Test sbe ffdc with bad target perv callout target instance 8" ],
            0xa9519e: [ "RC_PMIC_REDUNDANCY_FAIL_DDR5",
            ...
            0xa9a6dc: [ "RC_ODY_SCRATCH_REGS_INVALID_ACCESS_ERR",
                        "Requested hardware access method is not supported by platform" ],
            0xa9daee: [ "RC_POZ_IO_TX_TDR_ERROR",
                        "Tx TDR Lane Failure" ],
            0xa9e530: [ "RC_UNTRUSTED_RING_IMAGE",
                        "Untrusted scan image for scan types FUNC/REGF/LBST/CMSK" ],
            ...
            0xaa5674: [ "RC_EXPLORER_SAVED_IMAGEA_ERROR_LOG",
                        "Collect saved explorer errors during exp_collect_explorer_saved_log" ],
            0xaacc2f: [ "RC_THRESHOLD_STACK_LIMIT_CROSSED",
                        "Thread stack usage crossed threshold limit" ],
            ...
            0xab491a: [ "RC_IO_EXT_CMD_POLL_FAILED",
                        "IO external command done poll time-out" ],
            0xab6571: [ "RC_FILT_PLL_LOCK_ERR",
                        "Filter pll not locked" ],
            0xaba1f0: [ "RC_GETTRACEARRAY_TRACE_MUX_INCORRECT",
                        "The requested trace array's primary trace mux is not set up to capture the requested trace bus." ],
            ...
            0xae0f26: [ "RC_MSS_DDR5_MR33_CA_ODT_PER_DRAM_FIELD_VALUE",
                        "A bad CA ODT was processed by MR33" ],
            ...
            0xae1c28: [ "RC_ODY_INVALID_VERBOSITY_CONFIG",
                        "DRAMINIT verbosity cannot be configured to higher than COARSE_DEBUG on more than one port" ],
            ...
            0xb2a0a8: [ "RC_TEST_DIMM_TARGET2",
                        "Test sbe ffdc with bad target dimm with target instance 2" ],
            ...
            0xb4c6e4: [ "RC_ODY_DRAMINIT_REPAIRS_EXCEEDED_SWIZZLE",
                        "Ody draminit's recovery algorithm exceeded available repairs during the swizzle detect procedure." ],
            0xb4cb53: [ "RC_ODY_ECS_MR16_TO_19_PAT1",
                        "Collect MR16:19 data from ECS test fail for pattern1" ],
            0xb4cf3a: [ "RC_P10_IOP_TOP_PHY_ERROR",
                        "Invalid iop_top and/or Phy num to access XRAM." ],
            0xb4eec8: [ "RC_POZ_FFDC_SCRATCH_SPACE_FULL_ERROR",
                        "FFDC Heap Error - Scratch space FULL FFDC" ],
            ...
            0xb5494e: [ "RC_PUTRING_RS4_STRING_OVERRUN",
            ...
            0xb6d6f0: [ "RC_INVALID_2U_PMIC_TARGET_CONFIG",
                        "Expected to see 2 PMICs for 2U on the provided OCMB_TARGET in order to properly perform pmic_enable." ],
            ...
            0xb724b4: [ "RC_PM_ELOG_TBL_NOT_FOUND",
            ...
            0xb7b9f4: [ "RC_ADDR_NOT_RECOGNIZED",
            ...
            0xb91f84: [ "RC_SPI_TPM_ZERO_LENGTH_RW",
                        "Low-level read or write with zero length" ],
            ...
            0xbb8834: [ "RC_TARGET_ENTRY_MAGIC_WORD_MISMATCH",
                        "The magic word in the target section does not match with the procedure." ],
            ...
            0xbd289f: [ "RC_UNSUPPORTED_SCAN_TARGET_TYPE",
                        "Unsupported FAPI target type for scanning" ],
            ...
            0xbe342b: [ "RC_ODY_PHYINIT_INVALID_EN_TX_DM_PREAMBLE_PATTERN",
                        "Ody phyinit invalid EnTxDmPreamblePattern." ],
            ...
            0xbeb39a: [ "RC_TEST_CALLOUT_PERV_DECONFIGURE_GARD_TARGET8",
                        "Test sbe ffdc with bad target perv with deconfigure and gard with target instance 8" ],
            ...
            0xbed5c4: [ "RC_ALIGN_INTR",
                        "Alignment interrupt" ],
            0xbf1b3b: [ "RC_POZ_OPCG_DONE_NOT_SET_ERR",
                        "OPCG_DONE not set" ],
            ...
            0xc0ada2: [ "RC_ODY_DRAMINIT_NEW_BAD_BITS_FOUND",
                        "Ody draminit's recovery algorithm found new bad bits." ],
            ...
            0xc14abb: [ "RC_SPI_FLASH_NO_DEVICE",
                        "Got an all-zero response to a get device ID command, indicating that no SPI device might be attached" ],
            ...
            0xc17b9b: [ "RC_ODY_ROW_REPAIR_CCS_STUCK_IN_PROGRESS",
            ...
            0xc33e5a: [ "RC_ODY_DRAMINIT_TRAINING_FW_MISMATCH",
                        "Ody draminit training message block has an unsupported FW version. This can likely be solved by a firmware binary update" ],
            ...
            0xc37af3: [ "RC_SPI_TPM_RESPONSE_SIZE_MISMATCH",
                        "The size of the received TPM response does not match the length field in the response header" ],
            ...
            0xc3d42c: [ "RC_MSS_INVALID_CCS_INSTR_OFFSET",
                        "Requested CCS Program has invalid instruction offset." ],
            ...
            0xc46459: [ "RC_ODY_DRAMINIT_SWIZZLE_INVALID_RANK",
                        "DRAMINIT swizzle detect recovery found an invalid PHY rank" ],
            ...
            0xc53526: [ "RC_UNEXPECTED_DATA_SIZE",
                        "The attribute size does not match with the size expected by the procedure." ],
            ...
            0xc749d8: [ "RC_INVALID_RING_IMAGE",
                        "Invalid RS4 header in scan image" ],
            0xc757b9: [ "RC_EXP_MEMDIAGS_MCBIST_FAILED_TO_START",
                        "The MCBIST engine failed to start its program" ],
            0xc81378: [ "RC_MSS_MAINT_BAD_SPARE_INDEX",
            ...
            0xc99223: [ "RC_MSS_CHANNEL_MIRROR_SETTINGS_MISMATCH_RANK1",
                        "Mirroring settings mismatch between channels in DDR5 SPD byte 365" ],
            ...
            0xcacc84: [ "RC_PM_VDN_MAX_VOLTAGE_EXCEED",
                        "Total VDN voltage(VPD VDN + UPLIFT + LOALINE) value exceeds more than MAX_ALLOWED_VDN_VOLTAGE" ],
            ...
            0xcb796d: [ "RC_DONE_HALT_NOT_SET",
                        "DONE / HALT not measured by end of polling" ],
            ...
            0xcc3789: [ "RC_POZ_I2C_STATUS_ERROR",
                        "I2C status error - one of the error bits set" ],
            ...
            0xcf709c: [ "RC_ODYSSEY_I2CC_RESET_ERROR",
                        "Error resetting Odyssey I2C controller" ],
            ...
            0xd0146e: [ "RC_ODY_PPR_RESOURCE_UNAVAILABLE",
                        "PPR resources on DRAM were not available for a requested row repair operation" ],
            ...
            0xd0b0fd: [ "RC_POZ_I2C_FAILED_TO_LOCK_ENGINE_TIMEOUT_ERROR",
                        "I2C failed to lock i2c engine - Timeout error" ],
            ...
            0xd1a7d0: [ "RC_MSS_PLUG_RULES_DDR5_DIMM_SPD_REV_NOT_CURRENT",
                        "Detected an older version of SPD than the minimum supported DDR5 revision. This check can be skipped by setting the ATTR_MEM_IGNORE_PLUG_RULES_SPD_REV_CHECK to YES. Refer to ATTR_MEM_EFF_MIN_SUPPORTED_SPD_REVISION for the min version" ],
            ...
            0xd51846: [ "RC_MSS_DDR5_MR33_CA_ODT_ATTR_VALUE",
                        "A bad CA ODT was passed to MR33" ],
            0xd54e20: [ "RC_SBE_VERIFY_HBBL_FAIL_IN_MPIPL",
                        "SBE Failed to verify hbbl in MPIPL" ],
            ...
            0xd62168: [ "RC_EXP_MEMDIAGS_SUPERFAST_INIT_FAILED_TO_INIT",
                        "A superfast init operation failed initialization" ],
            0xd62e26: [ "RC_TEST_CALLOUT_DIMM_DECONFIG_TARGET0",
                        "Test sbe ffdc with bad target dimm with deconfig with target instance 0" ],
            ...
            0xd6ab29: [ "RC_MSS_DDR5_MR33_DQS_RTT_PARK_PER_DRAM_ATTR_VALUE",
                        "A bad DQS RTT Park value was passed to MR33" ],
            ...
            0xd6d0b7: [ "RC_ODYSSEY_I2C_ERROR",
                        "Odyssey init error, can't read CFAM via I2C." ],
            0xd6d2da: [ "RC_SBE_TARGET_ERROR",
                        "Generic sbe target error" ],
            ...
            0xd8fba3: [ "RC_POZ_SPPE_NOT_READY_ERR",
            ...
            0xddf9a7: [ "RC_ODY_MCBIST_DATA_FAIL",
                        "MCBIST program appeared to have failed, but set conflicting bits in the status register" ],
            0xde29c6: [ "RC_INVALID_MRW_FREQ_LIMIT_BY_CONFIG_ATTR",
                        "An invalid value was provided by ATTR_MSS_MRW_CONFIG_FREQ_LIMIT" ],
            ...
            0xde627e: [ "RC_ODY_INVALID_ATTR_MEM_SI_MC_DRV_IMP_CMD_ADDR",
                        "Invalid value detected in ATTR_MEM_SI_MC_DRV_IMP_CMD_ADDR. Likely due to an attribute override because SPD values are checked in mss_eff_config step." ],
            ...
            0xdeea27: [ "RC_OCC_SANDBOX_SIZE_ERROR",
                        "ATTR_PROC_OCC_SANDBOX_SIZE contains an invalid size value." ],
            ...
            0xe0f4f0: [ "RC_ERROR_UNSUPPORTED_BY_SBE",
                        "An error was encountered that the SBE didn't expect." ],
            ...
            0xe366f2: [ "RC_POZ_INVALID_CLOCK_TYPE",
                        "Invalid clock_type passed to check_clock_status function" ],
            ...
            0xe3ce81: [ "RC_PSTATE_NODE_PAU_FREQ_MISMATCH",
                        "The PAU frequency for this part does not match the others in the same node. This indicates the parts from different sorts may be plugged into the machine." ],
            ...
            0xe82127: [ "RC_MOD_MULTICAST_SETUP_PLAT_REMAP_ERR",
                        "Unable to remap input multicast group" ],
            ...
            0xe8edd1: [ "RC_WOF_HEADER_DATA_MAX_POWR_INVALID",
                        "Max powr value in WOF header and attribute value are 0." ],
            ...
            0xea2874: [ "RC_UNEXPECTED_ATTR_FORMAT_VER",
                        "The attribute data format does not match the version of the procedure." ],
            ...
            0xea382e: [ "RC_SBE_BOOT_CHECK_ERR_SCOM_PATH",
                        "SBE did not Boot prior to timeout in SCOM Path" ],
            ...
            0xebf109: [ "RC_ODY_PHYINIT_UNSUPPORTED_DDR_FREQ",
                        "An unsupported DDR frequency passed into ddrphyinit" ],
            ...
            0xec72e6: [ "RC_POZ_CBS_NOT_IN_IDLE_STATE",
                        "CBS did not complete (did not arrive in IDLE state) within timeout" ],
            ...
            0xecefeb: [ "RC_EXP_MEMDIAGS_TARGETED_SCRUB_FAILED_TO_INIT",
                        "A continuous scrub operation failed initialization" ],
            0xed0d44: [ "RC_INVALID_ATTR_INDEX",
                        "The attribute index is expected to be row=0xff, col=0xff, and hgt=0xff. If they don't match, then it may be due to data corruption, software bug, or due to data formatting errors. So, this error is considered as a hard stop." ],
            0xed2ad5: [ "RC_INVALID_TP_REGIONS",
                        "Invalid permutation of regions for TP BIST" ],
            ...
            0xee9579: [ "RC_MSS_MAINT_BAD_STEER_MUX_TYPE",
            ...
            0xf1b564: [ "RC_ODY_DRAMINIT_FATAL_ERROR_NOT_RECOVERED",
                        "This DIMM took a fatal draminit error and did not successfully recover" ],
            0xf1f3a1: [ "RC_HCODE_INVALID_TEMP2_BUF",
                        "Temporary buffer2 is invalid" ],
            0xf1fad4: [ "RC_MSS_ODY_DQS_DRIFT_TRACK_CHIPOP_NOT_HALF_DIMM",
                        "Odyssey chip-op DQS drift track only supports XMETA mode." ],
            0xf20eec: [ "RC_ODY_ROW_REPAIR_WITH_MNFG_REPAIRS_DISABLED",
                        "Valid row repair was requested while repairs are disabled." ],
            ...
            0xf3e13a: [ "RC_ODY_SCRATCH_REGS_UTILS_BUCKET_OUT_OF_RANGE_ERR",
                        "Specified PLL bucket is out of range" ],
            ...
            0xf7b62d: [ "RC_ODY_GETTRACEARRAY_INVALID_MUX",
                        "The trace control select for this trace array does not match the position of the requested trace bus." ],
            ...
            0xfb40be: [ "RC_INVALID_SCAN_TARGET_TYPE",
                        "Scan image target type does not match expectation based on FAPI target" ],
            ...
            0xfc6b19: [ "RC_SPI_TPM_READ_ABORT",
                        "A TPM read resulted in the TPM aborting the cycle and returning all-F data" ],
            ...
            0xfcd512: [ "RC_GETTRACEARRAY_CLOCKS_OFF",
                        "The requested trace array's clocks are not enabled." ],
            0xfd0ed9: [ "RC_POZ_HEARTBEAT_NOT_SET_ERR",
            ...
            0xfde56c: [ "RC_ODY_PORT_INDEX_OUT_OF_BOUNDS",
                        "Port index supplied to row repair function out of bounds." ],
            0xfde599: [ "RC_MSS_IRRELEVANT_FUNC_CALL",
                        "An invalid/irrelevant function call is made" ],
            ...
            0xfe41a2: [ "RC_ODY_GETTRACEARRAY_CLOCKS_OFF",
                        "The requested trace array's clocks are not enabled." ],
            ...
            0xff1d65: [ "RC_SPI_MEMORY_ERASE_MISMATCH",
                        "A Flash write operation ended with the erase sequence not stopping at the expected final address" ],

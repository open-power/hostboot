...
#ifndef __HOSTBOOT_RUNTIME
/******************************************************************************/
// migrateDimmGardRecordsForward
/******************************************************************************/
errlHndl_t DeconfigGard::migrateDimmGardRecordsForward( std::vector<GardRecordPair_t>& o_modifiedRecords )
{
    HWAS_INF(">>>migrateDimmGardRecordsForward() - num=%d", o_modifiedRecords.size());
    ...
    //  to the level of code with this change, the meaning of that guard
    ...
    HWAS_INF("<<<migrateDimmGardRecordsForward()");
    return l_err;
}

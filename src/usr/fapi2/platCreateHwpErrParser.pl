...
foreach my $argnum (1 .. $#ARGV)
{
    ...
    foreach my $err (@{$errors->{hwpError}})
    {
        ...
        foreach my $ffdc (@{$err->{ffdc}})
        {
            ...
            # switched elif for just if statements as ffdcId is unique
            # python3.9 only allows up to 2940 elif statements before recursion depth error
            print TGFILEPY "    if ffdcId == 0x$ffdcHash32Bit:\n";

...
// $Id: p8_pm_pmc_firinit.C,v 1.7 2012/10/05 08:44:13 pchatnah Exp $
// $Source: /afs/awd.austin.ibm.com/projects/eclipz/KnowledgeBase/.cvsroot/eclipz/chips/p8/working/procedures/ipl/fapi/p8_pm_pmc_firinit.C,v $
//------------------------------------------------------------------------------
...
// ----------------------------------------------------------------------
   ...
   CONST_UINT64_T( PMC_FIR_ACTION1_0x01010847        , ULL(0x01010847)) ;
   CONST_UINT64_T( PMC_FIR_ACTION0_0x01010846        , ULL(0x01010846)) ;
   CONST_UINT64_T( PMC_FIR_MASK_WR_0x01010843        , ULL(0x01010843)) ;
   CONST_UINT64_T( PMC_FIR_MASK_WR_AND_0x01010844        , ULL(0x01010844)) ;
   CONST_UINT64_T( PMC_FIR_MASK_WR_OR_0x01010845        , ULL(0x01010845)) ;
...
fapi::ReturnCode
p8_pm_pmc_firinit(const fapi::Target& i_target  )
{
      fapi::ReturnCode rc;
    ...
    FAPI_INF("");
    FAPI_INF("Executing p8_pm_pmc_firinit  ....\n");
    ...
    SET_MALF_ALERT(PMC_OCC_HEARTBEAT_TIMEOUT               ); //   	   	   pmc_occ_heartbeat_timeout                          
    ...
    FAPI_INF(" action_0                      => 0x%16llx ",  action_0.getDoubleWord(0));
    FAPI_INF(" action_1                      => 0x%16llx ",  action_1.getDoubleWord(0));
    FAPI_INF(" mask                          => 0x%16llx ",  mask.getDoubleWord(0));
    ...
    rc = fapiPutScom(i_target, PMC_FIR_ACTION0_0x01010846, action_0 );
    if (rc) {
      FAPI_ERR("fapiPutScom(PMC_FIR_ACTION0_0x01010846) failed."); return rc;
    }
    ...
    rc = fapiPutScom(i_target, PMC_FIR_ACTION1_0x01010847, action_1 );
    if (rc) {
      FAPI_ERR("fapiPutScom(PMC_FIR_ACTION1_0x01010847) failed."); return rc;
    }
    ...
    //--******************************************************************************
    rc = fapiPutScom(i_target, PMC_FIR_MASK_WR_0x01010843, mask );
    if (rc) {
      FAPI_ERR("fapiPutScom(PMC_FIR_MASK_WR_0x01010843) failed."); return rc;
    }

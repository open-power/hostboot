...
CPPCHECKFLAGS := --inline-suppr --suppress=internalAstError:*  --suppress=unknownMacro:* --suppress=preprocessorErrorDirective:* --quiet --xml --xml-version=2 --error-exitcode=1 --template='Error CPPCHECK {file}: line {line}\nSyntax error string: {id}\n{message}'

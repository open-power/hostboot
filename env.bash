...
#
# Contributors Listed Below - COPYRIGHT 2010,2026
...
# Default to Rochester but optimize based on HOSTNAME
if [ -z "${HOSTBOOT_ENVIRONMENT}" ]; then
  export HOSTBOOT_ENVIRONMENT=/gsa/rchgsa/projects/h/hostboot/
  ...
  if [ ! -f ${ARTIFACTFILE} ]; then
    ...
    # this is somewhat redundant with the else but leaving as example for future site moves
